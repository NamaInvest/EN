...
const bashCommand = `
echo "Setting up Database with schema auth..."
...
sudo -u postgres psql -d testdb99 -c "DROP SCHEMA IF EXISTS public CASCADE;"
sudo -u postgres psql -d testdb99 -c "CREATE SCHEMA public AUTHORIZATION testdb99;"
