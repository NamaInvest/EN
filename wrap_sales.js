const fs = require('fs');
let file = fs.readFileSync('d:/namasoft9-3-main/src/app/(dashboard)/sales/page.tsx', 'utf8');
...
fs.writeFileSync('d:/namasoft9-3-main/src/app/(dashboard)/sales/page.tsx', file);
console.log("Done");
