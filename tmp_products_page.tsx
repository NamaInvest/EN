                    ...
                    <div className="modal modal-lg" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="grid-2">
                            <div className="input-group">
                                ...
                                <input className="input" value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} placeholder="اسم المنتج بالعربي" />
                            </div>
                            <div className="input-group">
                            ...
                            <div className="input-group">
                                ...
                                <input className="input" value={form.barcode} onChange={e => setForm({ ...form, barcode: e.target.value })} placeholder="رقم الباركود" dir="ltr" />
                            </div>
                            <div className="input-group">
