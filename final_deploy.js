...
conn.on('ready', () => {
    conn.sftp((err, sftp) => {
        ...
        const files = [
            ...
            ['d:/namasoft9-3-main/src/middleware.ts', '/www/wwwroot/namainvist.com/src/middleware.ts', 'main-site middleware'],
            ['d:/namasoft9-3-main/src/middleware.ts', '/www/wwwroot/n11.namainvist.com/src/middleware.ts', 'saas-app middleware'],
            // check-status → saas-app only (main-site will call saas-app internally)
            ['d:/namasoft9-3-main/src/app/api/tenant/check-status/route.ts', '/www/wwwroot/n11.namainvist.com/src/app/api/tenant/check-status/route.ts', 'saas-app check-status'],
        ];
