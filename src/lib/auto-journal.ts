...
import { SubledgerAccountingService } from './services/subledger-accounting';
 ...
 */
export async function postSalesInvoice(invoice: any) {
    return SubledgerAccountingService.postSalesInvoice(invoice);
}
 ...
 */
export async function postPurchaseInvoice(invoice: any) {
    return SubledgerAccountingService.postPurchaseInvoice(invoice);
}
