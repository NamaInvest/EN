...
const LABELS: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    'i.po': 'أوامر الشراء', 'i.grn': 'سندات الاستلام', 'i.ap_capture': 'صندوق وارد الفواتير (OCR)',
    ...
    'i.succession_planning': 'تخطيط التعاقب الوظيفي',
    'i.bad_debt': 'الديون المعدومة',
    'i.vendor_onboarding': 'تأهيل الموردين',
    'i.rfx_auction': 'مناقصات ومزايدات RFX',
    'i.deferred_tax': 'الضرائب المؤجلة',
    'i.impairment': 'الهبوط في قيمة الأصول',
    'i.transfer_pricing': 'التسعير التحويلي',
    'i.campaigns': 'الحملات التسويقية',
    'i.tickets': 'تذاكر الدعم',
    'i.bi_dashboard': 'لوحة ذكاء الأعمال',
    'i.budget_scenarios': 'سيناريوهات الميزانية',
    'i.ecommerce': 'التجارة الإلكترونية',
    'i.contract_templates': 'قوالب العقود',
    'i.sub_plans': 'خطط الاشتراك',
    'i.ecommerce_stores': 'المتاجر الإلكترونية',
    'i.grc': 'الحوكمة والمخاطر',
    'i.knowledge': 'قاعدة المعرفة',
    'i.events': 'الفعاليات',
    'i.esign': 'التوقيع الإلكتروني',
    'i.cmms': 'إدارة الصيانة',
    'i.logistics': 'النقل واللوجستيات',
    'i.lms': 'التعلم الإلكتروني',
    'i.audits': 'التدقيق الداخلي',
    'i.maint_wo': 'أوامر الصيانة',
    'i.carriers': 'شركات الشحن',
    'i.planning': 'التخطيط والجدولة',
    'i.portal': 'بوابة العملاء',
    'i.rental': 'إدارة الإيجارات',
    'i.field_service': 'الخدمة الميدانية',
    'i.pos_offline': 'POS أوفلاين',
    ...
    'i.profit_centers': 'مراكز الربحية',
    'i.segments': 'القطاعات',
    'i.copa': 'تحليل الربحية (CO-PA)',
    'i.copa_rules': 'قواعد توزيع التكاليف',
    'i.num_seq': 'تسلسل الترقيم',
    'i.state_machine': 'حالات المستندات',
    'i.field_audit': 'سجل التعديلات',
    'i.period_close': 'إغلاق الفترات',
    ...
    's.saudi_compliance': 'ا🇸🇦 الامتثال السعودي',
    'i.qiwa_sync': 'ربط قوى (Qiwa)',
    'i.saudization': 'نسبة السعودة ونطاقات',
    'i.qiwa_contracts': 'عقود العمل (Qiwa)',
    'i.nitaqat_sim': 'محاكي نطاقات',
    'i.pdpl_dsr': 'طلبات أصحاب البيانات (PDPL)',
    'i.pdpl_breach': 'حوادث الاختراق',
    'i.vat_categories': 'تصنيفات ضريبية (VAT)',
    'i.period_lock': 'إقفال الفترات المحاسبية',
    'i.profit_loss': 'قائمة الدخل (P&L)',
    'i.vat_return': 'إقرار ضريبة القيمة المضافة',
    'i.fin_health': 'الصحة المالية (Z-Score)',
    'i.collection_wf': 'إدارة التحصيل',
    'i.prepayments_ui': 'المدفوعات المقدمة',
    'i.interco': 'المعاملات البينية (IC)',
    'i.wht_form14': 'نموذج 14 استقطاع',
    'i.mudad_compliance': 'امتثال مداد',
    'i.zakat_assessment': 'تقييم الزكاة',
    's.pharmacy': '💊 الصيدلية والرعاية الصحية',
    's.new_modules': '🚀 الوحدات الجديدة',
    's.v3_verticals': '🏢 حلول الصناعات V3',
    'i.v3_retail': 'لوحة تحكم التجزئة',
    'i.v3_restaurant': 'لوحة تحكم المطاعم',
    'i.v3_mfg': 'لوحة تحكم التصنيع',
    'i.v3_construction': 'لوحة تحكم المقاولات',
    'i.v3_clinic': 'لوحة تحكم العيادات',
    'i.v3_school': 'لوحة تحكم المدارس',
    'i.v3_realestate': 'لوحة تحكم العقارات',
    'i.v3_distribution': 'لوحة تحكم التوزيع',
    'i.v3_services': 'لوحة تحكم الخدمات',
    'i.v3_retail_pos': 'نقاط البيع المتعددة (POS)',
    'i.v3_restaurant_kds': 'شاشة المطبخ (KDS)',
    'i.v3_mfg_mrp': 'محرك التصنيع (MRP)',
    'i.v3_construction_boq': 'المستخلصات و BOQ',
    'i.v3_clinic_emr': 'الملف الطبي (EMR)',
    'i.v3_school_sis': 'نظام الطلاب (SIS)',
    'i.v3_realestate_leases': 'إدارة العقود والأملاك',
    'i.v3_distribution_wms': 'إدارة المستودعات (WMS)',
    'i.v3_services_timesheet': 'ساعات العمل والمصاريف',
    'i.webhooks': 'ربط Webhooks',
    'i.credit_check': 'فحص الحد الائتماني',
    'i.cash_forecast': 'توقع التدفقات النقدية',
    'i.number_sequences': 'تسلسل الترقيم',
    'i.cpq': 'تسعير ذكي (CPQ)',
    'i.rebates': 'برامج الخصم المؤجل',
    'i.sales_forecast': 'توقع المبيعات',
    'i.vendor_scorecard': 'تقييم الموردين',
    'i.aps_scheduler': 'جدولة متقدمة (APS)',
    'i.project_evm': 'قيمة مكتسبة (EVM)',
    'i.wave_picking': 'التقاط موجي (WMS)',
    'i.mes_oee': 'كفاءة المعدات (OEE)',
    'i.bi_cube': 'تحليلات ذكية (BI)',
    'i.nlq': 'اسأل النظام (NLQ)',
    'i.spend_analytics': 'تحليل الإنفاق',
    'i.service_sla': 'اتفاقيات الخدمة (SLA)',
    'i.prev_maintenance': 'صيانة وقائية',
    'i.sso_saml': 'تسجيل موحد (SSO)',
    'i.aging_report': 'تقادم الديون',
    'i.kanban_board': 'لوحة كانبان',
    'i.timesheet': 'سجل الدوام',
    'i.self_service': 'بوابة الموظف',
    'i.contracts_mgmt': 'إدارة العقود',
    'i.vendor_portal_page': 'بوابة الموردين',
    'i.workflow_builder': 'مصمم سير العمل',
    'i.print_templates': 'قوالب الطباعة',
    'i.dashboard_builder': 'لوحة تحكم مخصصة',
    'i.import_export': 'استيراد / تصدير',
    'i.dms': 'إدارة المستندات',
    'i.calendar': 'التقويم',
    'i.pivot_table': 'جدول محوري',
    'i.customer360': 'عرض شامل للعميل (360°)',
    'i.reorder_rules': 'قواعد إعادة الطلب',
    'i.notifications': 'الإشعارات',
    'i.expense_reports': 'تقارير المصروفات',
    'i.org_chart': 'الهيكل التنظيمي',
    'i.global_search': 'البحث الشامل',
    'i.chatter': 'التعليقات',
    'i.deferred_rev': 'الإيرادات المؤجلة',
    'i.shipping': 'شركات الشحن',
    'logout': 'تسجيل الخروج',
  },
  en: {
    ...
    'i.po': 'Purchase Orders (PO)', 'i.grn': 'Goods Receipt (GRN)', 'i.ap_capture': 'Invoice Capture (OCR)',
    ...
    'i.profit_centers': 'Profit Centers',
    'i.segments': 'Segments',
    'i.copa': 'Profitability Analysis (CO-PA)',
    'i.copa_rules': 'Cost Allocation Rules',
    'i.num_seq': 'Number Sequences',
    'i.state_machine': 'Document States',
    'i.field_audit': 'Field Audit Trail',
    'i.period_close': 'Period Close',
    'i.period_lock': 'Period Lock (Accounting)',
    'i.open_items': 'Open Items Preview',
    'i.profit_loss': 'Profit & Loss Statement',
    'i.vat_return': 'VAT Return (Box 1-12)',
    'i.fin_health': 'Financial Health (Z-Score)',
    'i.collection_wf': 'AR Collection Workflow',
    'i.prepayments_ui': 'Prepayments & Amortization',
    'i.interco': 'Inter-Company Transactions',
    ...
    's.saudi_compliance': '🇸🇦 Saudi Compliance',
    'i.qiwa_sync': 'Qiwa Integration',
    'i.saudization': 'Saudization & Nitaqat',
    'i.qiwa_contracts': 'Work Contracts (Qiwa)',
    'i.nitaqat_sim': 'Nitaqat Simulator',
    'i.pdpl_dsr': 'Data Subject Requests (PDPL)',
    'i.pdpl_breach': 'Breach Incidents',
    'i.vat_categories': 'VAT Categories',
    'i.wht_form14': 'WHT Form 14',
    'i.mudad_compliance': 'Mudad Compliance',
    'i.zakat_assessment': 'Zakat Assessment',
    's.pharmacy': '💊 Pharmacy & Healthcare',
    's.new_modules': '🚀 New Modules',
    's.v3_verticals': '🏢 Industry Verticals V3',
    'i.v3_retail': 'Retail Dashboard',
    'i.v3_restaurant': 'Restaurant Dashboard',
    'i.v3_mfg': 'Mfg Dashboard',
    'i.v3_construction': 'Const. Dashboard',
    'i.v3_clinic': 'Clinic Dashboard',
    'i.v3_school': 'School Dashboard',
    'i.v3_realestate': 'Real Estate Dash',
    'i.v3_distribution': 'Distribution Dash',
    'i.v3_services': 'Services Dashboard',
    'i.v3_retail_pos': 'Multi-Branch POS',
    'i.v3_restaurant_kds': 'Kitchen Display (KDS)',
    'i.v3_mfg_mrp': 'MRP Engine',
    'i.v3_construction_boq': 'BOQ & Progress Billing',
    'i.v3_clinic_emr': 'Electronic Medical Records',
    'i.v3_school_sis': 'Student Information System',
    'i.v3_realestate_leases': 'Leases & Property',
    'i.v3_distribution_wms': 'Advanced WMS',
    'i.v3_services_timesheet': 'Timesheets & Expenses',
    'i.webhooks': 'Webhooks',
    'i.credit_check': 'Credit Check',
    'i.cash_forecast': 'Cash Forecast',
    'i.number_sequences': 'Number Sequences',
    'i.cpq': 'Configure-Price-Quote',
    'i.rebates': 'Rebate Programs',
    'i.sales_forecast': 'Sales Forecast',
    'i.vendor_scorecard': 'Vendor Scorecard',
    'i.aps_scheduler': 'APS Scheduler',
    'i.project_evm': 'Earned Value (EVM)',
    'i.wave_picking': 'Wave Picking (WMS)',
    'i.mes_oee': 'OEE Dashboard',
    'i.bi_cube': 'BI Analytics',
    'i.nlq': 'Ask System (NLQ)',
    'i.spend_analytics': 'Spend Analytics',
    'i.service_sla': 'Service SLA',
    'i.prev_maintenance': 'Preventive Maintenance',
    'i.sso_saml': 'SSO / SAML',
    'i.aging_report': 'Aging Reports',
    'i.kanban_board': 'Kanban Board',
    'i.timesheet': 'Timesheet',
    'i.self_service': 'Employee Portal',
    'i.contracts_mgmt': 'Contract Management',
    'i.vendor_portal_page': 'Vendor Portal',
    'i.workflow_builder': 'Workflow Builder',
    'i.print_templates': 'Print Templates',
    'i.dashboard_builder': 'Dashboard Builder',
    'i.import_export': 'Import / Export',
    'i.dms': 'Document Management',
    'i.calendar': 'Calendar',
    'i.pivot_table': 'Pivot Table',
    'i.customer360': 'Customer 360°',
    'i.reorder_rules': 'Reorder Rules',
    'i.notifications': 'Notifications',
    'i.expense_reports': 'Expense Reports',
    'i.org_chart': 'Org Chart',
    'i.global_search': 'Global Search',
    'i.chatter': 'Comments',
    'i.deferred_rev': 'Deferred Revenue',
    'i.shipping': 'Shipping Carriers',
    'i.campaigns': 'Marketing Campaigns',
    'i.tickets': 'Support Tickets',
    'i.bi_dashboard': 'BI Dashboard',
    'i.budget_scenarios': 'Budget Scenarios',
    'i.ecommerce': 'E-Commerce',
    'i.contract_templates': 'Contract Templates',
    'i.sub_plans': 'Subscription Plans',
    'i.ecommerce_stores': 'E-Commerce Stores',
    'i.grc': 'GRC & Risk',
    'i.knowledge': 'Knowledge Base',
    'i.events': 'Events',
    'i.esign': 'E-Signature',
    'i.cmms': 'Maintenance (CMMS)',
    'i.logistics': 'Logistics & TMS',
    'i.lms': 'LMS / eLearning',
    'i.audits': 'Internal Audits',
    'i.maint_wo': 'Maintenance Work Orders',
    'i.carriers': 'Carriers & Rates',
    'i.planning': 'Planning & Schedule',
    'i.portal': 'Customer Portal',
    'i.rental': 'Rental Management',
    'i.field_service': 'Field Service',
    'i.pos_offline': 'POS Offline',
    'logout': 'Logout',
  },
  hi: {
...
const menuItems = [
  ...
  },
  {
    sk: 's.purchases', items: [
      ...
      { icon: '📸', lk: 'i.ap_capture', href: '/ap/capture', module: 'purchases' },
  ...
  },
  {
    sk: 's.finance', items: [
      ...
      { icon: '🔢', lk: 'i.num_seq', href: '/settings/number-sequences', module: 'accounting' },
      { icon: '📊', lk: 'i.state_machine', href: '/settings/state-machine', module: 'accounting' },
      { icon: '📝', lk: 'i.field_audit', href: '/audit/field-trail', module: 'accounting' },
      ...
      { icon: '📋', lk: 'i.vat_return', href: '/accounting/vat-return', module: 'accounting' },
  ...
  },
  {
    sk: 's.crm', items: [
      ...
      { icon: '📚', lk: 'i.knowledge', href: '/knowledge/articles', module: 'knowledge' },
      { icon: '🎪', lk: 'i.events', href: '/events', module: 'events' },
      ...
      { icon: '🎓', lk: 'i.lms', href: '/lms/courses', module: 'lms' },
      ...
      { icon: '🧭', lk: 'i.field_service', href: '/field-service', module: 'field_service' },
  ...
  },
  {
    sk: 's.enterprise', items: [
      ...
      { icon: '🚛', lk: 'i.fleet', href: '/fleet', module: 'legal' },
  ...
  // ── الامتثال السعودي ──────────────────────────────────────────────────────
  {
    sk: 's.saudi_compliance', items: [
      { icon: '🔗', lk: 'i.qiwa_sync', href: '/hr/qiwa', module: 'hr' },
      { icon: '🇸🇦', lk: 'i.saudization', href: '/hr/saudization', module: 'hr' },
      { icon: '📋', lk: 'i.qiwa_contracts', href: '/hr/qiwa/contracts', module: 'hr' },
      { icon: '📊', lk: 'i.nitaqat_sim', href: '/hr/nitaqat-simulator', module: 'hr' },
      ...
      { icon: '💰', lk: 'i.vat_categories', href: '/finance/vat/categories', module: 'accounting' },
      { icon: '📑', lk: 'i.wht_form14', href: '/finance/wht/form14', module: 'accounting' },
      { icon: '🏦', lk: 'i.mudad_compliance', href: '/hr/mudad', module: 'hr' },
      { icon: '📿', lk: 'i.zakat_assessment', href: '/zakat', module: 'accounting' },
    ]
  },
  // ── قسم الصيدلية ─────────────────────────────────────────────────────────
  {
  ...
  // ── الوحدات الجديدة ───────────────────────────────────────────────────────
  {
    sk: 's.new_modules', items: [
      ...
      { icon: '🏦', lk: 'i.bank_integration', href: '/accounting/banks', module: 'accounting' },
      ...
      { icon: '🎁', lk: 'i.rebates', href: '/finance/rebates', module: 'accounting' },
      ...
      { icon: '📊', lk: 'i.bi_cube', href: '/reports/bi-cube', module: 'reports' },
      ...
      { icon: '📉', lk: 'i.aging_report', href: '/reports/aging', module: 'accounting' },
  ...
  },
  {
    sk: 's.v3_verticals', items: [
      { icon: '🛒', lk: 'i.v3_retail', href: '/v3/retail', module: 'sales', subItems: [{ icon: '📱', lk: 'i.v3_retail_pos', href: '/v3/retail/pos' }] },
      { icon: '🍔', lk: 'i.v3_restaurant', href: '/v3/restaurant', module: 'sales', subItems: [{ icon: '👨‍🍳', lk: 'i.v3_restaurant_kds', href: '/v3/restaurant/kds' }] },
      { icon: '🏭', lk: 'i.v3_mfg', href: '/v3/manufacturing', module: 'manufacturing', subItems: [{ icon: '⚙️', lk: 'i.v3_mfg_mrp', href: '/v3/manufacturing/mrp' }] },
      { icon: '🏗️', lk: 'i.v3_construction', href: '/v3/construction', module: 'projects', subItems: [{ icon: '🚧', lk: 'i.v3_construction_boq', href: '/v3/construction/boq' }] },
      { icon: '🏥', lk: 'i.v3_clinic', href: '/v3/clinic', module: 'pharmacy', subItems: [{ icon: '⚕️', lk: 'i.v3_clinic_emr', href: '/v3/clinic/emr' }] },
      { icon: '🎓', lk: 'i.v3_school', href: '/v3/school', module: 'schools', subItems: [{ icon: '👨‍🎓', lk: 'i.v3_school_sis', href: '/v3/school/sis' }] },
      { icon: '🏢', lk: 'i.v3_realestate', href: '/v3/realestate', module: 'legal', subItems: [{ icon: '📝', lk: 'i.v3_realestate_leases', href: '/v3/realestate/leases' }] },
      { icon: '🚚', lk: 'i.v3_distribution', href: '/v3/distribution', module: 'inventory', subItems: [{ icon: '📦', lk: 'i.v3_distribution_wms', href: '/v3/distribution/wms' }] },
      { icon: '💼', lk: 'i.v3_services', href: '/v3/services', module: 'projects', subItems: [{ icon: '⏳', lk: 'i.v3_services_timesheet', href: '/v3/services/timesheet' }] },
    ]
  },
  {
  ...
  },
  {
    sk: 's.settings', items: [
      ...
      { icon: '📚', lk: 'System Docs', href: '/docs', module: 'admin' },
      ...
      { icon: '🇸🇦', lk: 'ZATCA Phase 2', href: '/settings/zatca', module: 'settings' },
      { icon: '📊', lk: 'i.bi_builder', href: '/admin/bi-builder', module: 'admin' },
            ...
            return (
              <div key={gIdx} className="mb-1">
                <button
                  ...
                  className={`w-full flex items-center justify-between px-4 py-3 rounded-xl transition-colors ${isExpanded ? 'bg-slate-50 text-blue-600 font-bold' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-semibold'
                    }`}
                >
                  ...
                  {(group.items || []).map((item) => {
                    ...
                    return (
                      <Link
                        ...
                        href={item.href}
                        onClick={() => setIsOpen(false)}
                        className={`flex items-center gap-3 px-4 py-2.5 mx-2 rounded-lg text-[15px] transition-all ${isActive
