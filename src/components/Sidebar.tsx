...
const LABELS: Record<Lang, Record<string, string>> = {
  ...
  en: {
    ...
    'i.sales_invoices': 'Tax Invoices', 'i.sales_history': 'Invoice Register',
...
const menuItems = [
  ...
  },
  {
    sk: 's.sales', items: [
      ...
      { icon: '🗂️', lk: 'i.sales_history', href: '/sales/invoice-register', module: 'sales' },
      { icon: '📄', lk: 'i.sales_quotes', href: '/sales/quotations', module: 'price_quotes' },
