...
const menuItems = [
  ...
  { sk: 's.purchases', items: [
    ...
    { icon: '🌐', lk: 'Vendor Portal (Sourcing)', href: '/procurement/vendor-portal', module: 'purchases' },
    ...
    { icon: '📄', lk: 'Vendor Statements', href: '/accounting/vendor-statements', module: 'purchases' },
  ...
  { sk: 's.manufacturing', items: [
    { icon: '🏭', lk: 'Dashboard', href: '/manufacturing', module: 'manufacturing' },
    { icon: '🛠️', lk: 'i.bom', href: '/manufacturing/boms', module: 'manufacturing' },
    { icon: '🔨', lk: 'Work Orders', href: '/manufacturing/orders', module: 'manufacturing' },
  ...
  { sk: 'Quality Management', items: [
    { icon: '🔬', lk: 'QMS Dashboard', href: '/quality', module: 'manufacturing' },
    { icon: '✅', lk: 'Inspections', href: '/quality/inspections', module: 'manufacturing' },
    { icon: '⚠️', lk: 'NCRs', href: '/quality/ncrs', module: 'manufacturing' },
  ]},
  { sk: 'Product Lifecycle (PLM)', items: [
    { icon: '📐', lk: 'PLM Dashboard', href: '/manufacturing/plm', module: 'manufacturing' },
  ]},
  { sk: 's.finance', items: [
    ...
    { icon: '📥', lk: 'Bank Statement Imports', href: '/accounting/banks/imports', module: 'banks' },
    ...
    { icon: '➗', lk: 'Allocations', href: '/fng/allocations', module: 'accounting' },
    { icon: '🛡️', lk: 'Tax & ZATCA', href: '/tax', module: 'accounting' },
    ...
    { icon: '🧾', lk: 'Customer Statements UI', href: '/accounting/customer-statements', module: 'accounting' },
    ...
    { icon: '💰', lk: 'Revenue Recognition', href: '/accounting/revenue-recognition', module: 'accounting' },
    { icon: '📝', lk: 'Lease Accounting', href: '/accounting/leases', module: 'accounting' },
    { icon: '🔒', lk: 'Year-End Close', href: '/accounting/year-end-close', module: 'accounting' },
    { icon: '⚡', lk: 'Open Items', href: '/accounting/open-items', module: 'accounting' },
    { icon: '💸', lk: 'Payment Runs', href: '/accounting/payment-runs', module: 'accounting' },
  ]},
  { sk: 's.crm', items: [
    ...
    { icon: '🔁', lk: 'Subscriptions', href: '/subscriptions', module: 'customers' },
  ...
  { sk: 's.enterprise', items: [
    ...
    { icon: '🔧', lk: 'FSM Dashboard', href: '/fsm', module: 'fsm' },
    { icon: '🗺️', lk: 'Dispatch Board', href: '/fsm/dispatch', module: 'fsm' },
    { icon: '📱', lk: 'Technician Tasks', href: '/fsm/tasks', module: 'fsm' },
  ]},
  // ── قسم الصيدلية ─────────────────────────────────────────────────────────
  { sk: 's.pharmacy', items: [
  ...
  { sk: 's.new_modules', items: [
    ...
    { icon: '🏦', lk: 'Bank Integration', href: '/accounting/banking', module: 'accounting' },
    { icon: '🔒', lk: 'Period Close', href: '/accounting/period-close', module: 'accounting' },
  ...
  { sk: 's.settings', items: [
    ...
    { icon: '📊', lk: 'BI Report Builder', href: '/admin/bi-builder', module: 'admin' },
    { icon: '🧪', lk: 'E2E Flow Tester', href: '/admin/e2e-tester', module: 'admin' },
    { icon: '⚖️', lk: 'Audit & GRC', href: '/admin/grc', module: 'audit_logs' },
    { icon: '⚡', lk: 'V2 Orchestration', href: '/admin/orchestration', module: 'settings' },
    { icon: '🛡️', lk: 'Compliance Matrix', href: '/admin/compliance', module: 'settings' },
