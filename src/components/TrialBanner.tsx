...
export default function TrialBanner() {
    ...
    if (isExpired) {
        return (
            <div className="bg-red-600 font-cairo text-white px-4 py-2 text-center text-sm font-bold z-50">
    ...
    return (
        <div className="bg-amber-100 border-b border-amber-300 font-cairo text-amber-900 px-4 py-2 text-center text-sm font-semibold z-50">
