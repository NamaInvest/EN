                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden shadow-sm hover:border-pink-500 transition-colors">
                            <div className="p-5 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center bg-slate-50/50 dark:bg-slate-900/50">
                                <div className="flex items-center space-x-3 space-x-reverse">
                                    ...
                                    <div>
                                        <h2 className="text-lg font-bold text-slate-900 dark:text-white">المرحلة الابتدائية</h2>
                        ...
                        <div className="bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden shadow-sm hover:border-pink-500 transition-colors">
                            <div className="p-5 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center bg-slate-50/50 dark:bg-slate-900/50">
                                <div className="flex items-center space-x-3 space-x-reverse">
                                    ...
                                    <div>
                                        <h2 className="text-lg font-bold text-slate-900 dark:text-white">المرحلة المتوسطة</h2>
                        ...
                        <div className="bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden shadow-sm hover:border-pink-500 transition-colors">
                            <div className="p-5 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center bg-slate-50/50 dark:bg-slate-900/50">
                                <div className="flex items-center space-x-3 space-x-reverse">
                                    ...
                                    <div>
                                        <h2 className="text-lg font-bold text-slate-900 dark:text-white">المرحلة الثانوية (المسارات)</h2>
                    ...
                    <div className="space-y-6">
                        <div className="bg-white dark:bg-[#0F172A] p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
                            <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-6">إحصائيات هيكل المدرسة</h2>
                            ...
                            <div className="mt-8 pt-6 border-t border-slate-200 dark:border-slate-800">
                                <div className="grid grid-cols-2 gap-4 text-center">
                                    <div className="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                                        ...
                                        <p className="text-2xl font-bold font-[Fira_Code] text-slate-900 dark:text-white">48</p>
                                    </div>
                                    <div className="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                                        <p className="text-xs text-slate-500 dark:text-slate-400 mb-1">متوسط الكثافة</p>
                                        <p className="text-2xl font-bold font-[Fira_Code] text-slate-900 dark:text-white">26</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white dark:bg-[#0F172A] p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm text-center">
                            ...
                            <h3 className="font-bold text-slate-900 dark:text-white mb-2">إعدادات الرسوم والضرائب</h3>
