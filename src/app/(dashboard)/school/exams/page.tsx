...
export default function SchoolExams() {
 ...
 <h3 className="text-3xl font-bold text-slate-900 font-[Fira_Code]">94.2%</h3>
 </div>
 ...
 <h3 className="text-3xl font-bold text-slate-900 font-[Fira_Code]">245</h3>
 </div>
 ...
 <h3 className="text-3xl font-bold text-slate-900 font-[Fira_Code]">54</h3>
 </div>
 ...
 <div>
 <h2 className="text-lg font-bold text-slate-900 ">رصد الدرجات</h2>
 ...
 <h2 className="text-lg font-bold text-slate-900 mb-4">إصدار التقارير والشهادات</h2>
