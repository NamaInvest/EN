...
export default function SchoolDashboard() {
 ...
 <h3 className="text-3xl font-bold text-slate-900 font-[Fira_Code]">1,248</h3>
 </div>
 ...
 <h3 className="text-3xl font-bold text-slate-900 font-[Fira_Code]">92%</h3>
 </div>
 ...
 <h3 className="text-3xl font-bold text-slate-900 font-[Fira_Code]">96.5%</h3>
 </div>
 ...
 <h2 className="text-lg font-bold text-slate-900 ">الفصول والمقاعد المتاحة</h2>
 ...
 className="pl-4 pr-10 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-sm focus:outline-none focus:border-violet-500 transition-colors w-64"
 />
 </div>
 </div>
