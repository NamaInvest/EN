...
export default function AICopilot() {
 ...
 <div>
 <h1 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-l from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400">{_t('ناما AI مساعد الطيار', 'Nama AI Copilot')}</h1>
 ...
 <h3 className="font-bold mb-1">{_t('رؤية نما للذكاء الاصطناعي', 'Nama AI Vision')}</h3>
 ...
 <p className="text-center text-xs text-slate-400 mt-3 font-[Fira_Code]">{_t('مساعد الطيار يمكن أن يرتكب أخطاء. فكر في التحقق من البيانات المالية المهمة.', 'Copilot can make mistakes. Consider verifying important financial data.')}</p>
 </form>
 </div>
 </div>
