...
export default function WhatsAppSettingsPage() {
 ...
 <p className="text-sm text-slate-500">{t('sys.str_2539')}</p>
 </div>
 ) : status === 'connected' ? (
 ...
 <p className="text-slate-500 text-center text-sm">{t('sys.str_2541')}</p>
 </div>
 ) : status === 'scanning' && qr ? (
 ...
 <h3 className="font-semibold text-slate-800">{t('sys.str_2542')}</h3>
 ...
 <h3 className="font-semibold text-slate-800">{t('sys.str_2544')}</h3>
 <p className="text-sm text-slate-500 max-w-sm">{t('sys.str_2545')}</p>
 </div>
 )}
 </div>
 </div>
