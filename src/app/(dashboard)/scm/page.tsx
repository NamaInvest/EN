                    ...
                    <div className="bg-white dark:bg-[#0F172A] p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm hover:border-blue-500 transition-colors">
                        <div className="flex justify-between items-start">
                            <div>
                                ...
                                <h3 className="text-3xl font-bold text-slate-900 dark:text-white font-[Fira_Code]">4.2x</h3>
                            </div>
                    ...
                    <div className="bg-white dark:bg-[#0F172A] p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm hover:border-blue-500 transition-colors">
                        <div className="flex justify-between items-start">
                            <div>
                                ...
                                <h3 className="text-3xl font-bold text-slate-900 dark:text-white font-[Fira_Code]">8.4M ﷼</h3>
                            </div>
                    ...
                    <div className="bg-white dark:bg-[#0F172A] p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm hover:border-blue-500 transition-colors">
                        <div className="flex justify-between items-start">
                            <div>
                                ...
                                <h3 className="text-3xl font-bold text-slate-900 dark:text-white font-[Fira_Code]">14</h3>
                            </div>
