  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        {[1, 2, 3].map((i) => (
          <div key={i} className="card p-6 border border-(--border) bg-(--bg-secondary) rounded-xl shadow-sm opacity-60">
      ...
      <div className="card p-10 border border-(--border) bg-(--bg-primary) rounded-xl text-center shadow-sm">
