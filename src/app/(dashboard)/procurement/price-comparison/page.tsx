...
export default function PriceComparisonPage() {
  return (
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="card p-6 border border-(--border) bg-(--bg-secondary) mb-6 rounded-xl shadow-sm">
        <div className="flex gap-4 flex-col md:flex-row">
          <div className="flex-1 relative">
            ...
            <input 
              ...
              className="w-full p-3 pr-10 border border-(--border) rounded-lg bg-(--bg-primary) text-(--text) outline-none"
              disabled
              dir="auto"
            />
          </div>
      ...
      <div className="card p-16 border border-(--border) bg-(--bg-primary) rounded-xl text-center shadow-sm">
