    ...
    <div className="p-6" dir="rtl">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        {loading ? (
          ...
          <div className="p-8 text-center text-slate-500">{t('sys.str_4793')}</div>
        ) : (
          <table className="w-full text-right border-collapse">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200 text-slate-600">
                ...
                <th className="p-4 font-semibold">{t('sys.str_4794')}</th>
                ...
                <tr key={student.id} className="border-b border-slate-100 hover:bg-slate-50 transition">
                  ...
                  <td className="p-4">
                    <span className={`px-2 py-1 rounded text-xs font-semibold ${
                      ...
                      {student.status === 'ENROLLED' ? t('sys.str_4795') : student.status}
                    </span>
                  </td>
                </tr>
              ))}
