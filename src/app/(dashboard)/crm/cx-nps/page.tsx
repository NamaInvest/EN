    ...
    <div className="p-6">
      ...
      {loading ? (
        ...
        <div className="card p-8 text-center border border-(--border) bg-(--bg-secondary) rounded-xl shadow-sm">
          ...
          <h2 className="text-lg font-bold mb-2">No Surveys Collected</h2>
          <p className="text-(--text-muted)">The NPS tracking dashboard is waiting for initial customer feedback data.</p>
        </div>
      )}
    </div>
  );
