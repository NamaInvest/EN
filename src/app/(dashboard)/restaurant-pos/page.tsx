            ...
            <div className="hidden xl:flex w-[440px] bg-white border-r border-slate-200 flex flex-col z-20 shrink-0 shadow-[-10px_0_40px_rgba(0,0,0,0.03)] relative">
                ...
                <div className="p-8 bg-white border-t border-slate-200 flex flex-col gap-6 shadow-[0_-10px_40px_rgba(0,0,0,0.03)] z-10">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button onClick={() => handleCheckout('CARD')} disabled={cart.length === 0 || isProcessing} className="py-4 bg-[#0EA5E9] hover:bg-[#0284C7] text-white rounded-[1.25rem] font-bold text-lg flex items-center justify-center gap-2 transition-all shadow-[0_8px_20px_rgba(14,165,233,0.25)] active:scale-95 disabled:opacity-50 hover-micro">
                            <CreditCard className="w-5 h-5" /> MADA
                        </button>
                        <button onClick={() => handleCheckout('CASH')} disabled={cart.length === 0 || isProcessing} className="py-4 bg-[#10B981] hover:bg-[#059669] text-white rounded-[1.25rem] font-bold text-lg flex items-center justify-center gap-2 transition-all shadow-[0_8px_20px_rgba(16,185,129,0.25)] active:scale-95 disabled:opacity-50 hover-micro">
                        ...
                        <button 
                            ...
                            className="py-4 col-span-2 bg-[#1E293B] hover:bg-[#0F172A] text-white rounded-[1.25rem] font-bold text-lg flex items-center justify-center gap-2 transition-all shadow-[0_8px_20px_rgba(30,41,59,0.25)] active:scale-95 disabled:opacity-50 hover-micro"
                        >
