        ...
        <div className="max-w-7xl mx-auto space-y-6 p-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Manage and track withholding tax payments to non-resident parties.</p>
                </div>
            ...
            <Card className="overflow-hidden border-gray-200 shadow-sm bg-white">
                ...
                <div className="p-12 text-center text-gray-500">
                    ...
                    <h3 className="text-lg font-medium text-gray-900">No WHT records found</h3>
                    <p className="mt-1">Create a new WHT form to begin tracking withholding taxes.</p>
                </div>
            </Card>
        </div>
    );
