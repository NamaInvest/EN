...
export default function POSTerminal() {
 ...
 <div>
 <h1 className="font-bold text-slate-900 text-lg">نقطة البيع (POS)</h1>
 ...
 className="w-full pl-4 pr-12 py-3 bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800 rounded-xl text-lg focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all shadow-sm"
 />
 </div>
 </div>
 ...
 <span className="w-8 text-center font-bold font-[Fira_Code] text-slate-900 ">{item.qty}</span>
 ...
 <span className="font-bold text-slate-900 font-[Fira_Code]">{(item.price * item.qty).toFixed(2)} ﷼</span>
 </div>
 </div>
 ))}
 </div>
 ...
 <div className="flex justify-between text-slate-900 text-2xl font-black pt-3 border-t border-slate-200 dark:border-slate-700">
 <span>الإجمالي</span>
