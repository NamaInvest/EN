  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">Compliance & Security Posture</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-(--bg-secondary) border border-(--border) p-6 rounded-xl">
          ...
          <p className="text-sm text-(--text-muted)">{complianceStatus.soc2}% Controls Verified</p>
        </div>
        ...
        <div className="bg-(--bg-secondary) border border-(--border) p-6 rounded-xl">
          ...
          <p className="text-sm text-(--text-muted)">{complianceStatus.iso27001}% Controls Verified</p>
        </div>
        ...
        <div className="bg-(--bg-secondary) border border-(--border) p-6 rounded-xl">
          ...
          <p className="text-sm text-(--text-muted)">{complianceStatus.pdpl}% Compliant</p>
        </div>
      </div>
      ...
      <div className="bg-(--bg-secondary) border border-(--border) rounded-xl overflow-hidden mt-6">
        <div className="p-4 border-b border-(--border) bg-(--bg-primary)">
          <h2 className="font-semibold">Action Items (Controls Needing Review)</h2>
        </div>
        <div className="p-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="font-medium">ISO-A.9.2 - User Access Reviews</h4>
              <p className="text-sm text-(--text-muted)">Quarterly access review for Admin roles is pending.</p>
              <span className="text-xs text-gray-700 bg-gray-100 px-2 py-1 rounded mt-2 inline-block">Due in 14 days</span>
            </div>
          </div>
        </div>
      </div>
