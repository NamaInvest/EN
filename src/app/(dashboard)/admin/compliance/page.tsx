    ...
    return (
        <div className="max-w-7xl mx-auto space-y-6 p-6">
            <h1 className="text-3xl font-bold flex items-center gap-2">
                ...
                V2 Cross-Cutting Compliance Matrix
            </h1>
            <p className="text-gray-500">Monitoring the 10 core cross-cutting concerns (Security, Auditing, Multi-GAAP, ZATCA).</p>
            ...
            <Card className="p-6">
                <h2 className="text-xl font-semibold mb-4 flex items-center gap-2"><AlertTriangle className="text-orange-500" /> Compliance Incident Logs</h2>
