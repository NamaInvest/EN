...
export default function DunningDashboard() {
 ...
 <p className="text-slate-500 mt-1 text-sm">{_t('تذكير آلي متعدد المستويات وتوليد رسوم تأخير للحسابات المتأخرة', 'Automated multi-level reminders and late fee generation for overdue accounts')}</p>
 </div>
 ...
 <p className="text-sm font-medium text-slate-500">{_t('إجمالي المديونيات المتأخرة', 'Overdue AR Balance')}</p>
 <h3 className="text-2xl font-bold text-slate-900 font-mono mt-1">450,000.00</h3>
 </div>
 <div className="bg-white p-5 rounded-lg border border-slate-200 shadow-sm flex items-center justify-between">
 <div>
 <p className="text-sm font-medium text-slate-500">{_t('خطابات مرسلة (30 يوم)', 'Letters Sent (30d)')}</p>
 <h3 className="text-2xl font-bold text-slate-900 font-mono mt-1">124</h3>
 </div>
 <Mail className="w-8 h-8 text-blue-500 opacity-20" />
 </div>
 <div className="bg-white p-5 rounded-lg border border-slate-200 shadow-sm flex items-center justify-between">
 <div>
 <p className="text-sm font-medium text-slate-500">{_t('مُحصل (30 يوم)', 'Recovered (30d)')}</p>
 ...
 <div className="p-4 border-b border-slate-200 flex space-x-4 gap-4">
 ...
 <button className="text-sm font-medium text-slate-500 hover:text-slate-700 pb-2">{_t('إعدادات مستويات التحصيل', 'Dunning Levels Setup')}</button>
 </div>
 ...
 <tr>
 <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">{_t('العميل', 'Customer')}</th>
 <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">{_t('الفاتورة / المرجع', 'Invoice / Ref')}</th>
 <th className="px-6 py-3 text-center text-xs font-medium text-slate-500 uppercase tracking-wider">{_t('تأخير', 'Overdue')}</th>
 <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">{_t('مستوى التحصيل', 'Dunning Level')}</th>
 <th className="px-6 py-3 text-right text-xs font-medium text-slate-500 uppercase tracking-wider">{_t('الإجمالي', 'Total Due')}</th>
 <th className="px-6 py-3 text-center text-xs font-medium text-slate-500 uppercase tracking-wider">{_t('إجراء', 'Action')}</th>
 </tr>
 </thead>
 <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700">
 <tr className="hover:bg-slate-50 dark:hover:bg-gray-700/50">
 <td className="px-6 py-4 whitespace-nowrap">
 <div className="text-sm font-medium text-slate-900 ">Delta Contracting Est</div>
 <div className="text-xs text-slate-500">delta@example.com</div>
 </td>
 <td className="px-6 py-4 whitespace-nowrap">
 ...
 <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-mono font-medium text-slate-900 ">
 12,500.00
 </td>
 ...
 <tr className="hover:bg-slate-50 dark:hover:bg-gray-700/50">
 <td className="px-6 py-4 whitespace-nowrap">
 <div className="text-sm font-medium text-slate-900 ">Riyadh Tech Co</div>
 <div className="text-xs text-slate-500">finance@riyadhtech.sa</div>
 </td>
 <td className="px-6 py-4 whitespace-nowrap">
