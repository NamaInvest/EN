  ...
  const _t = (ar: string, en: string) => lang === 'ar' ? ar : en;
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6 p-6">
            ...
            <p className="text-gray-500">Run monthly depreciation, FX revaluation, and lock accounting periods.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="p-6 space-y-4 border-t-4 border-t-orange-400">
                    ...
                    <Button onClick={() => handleAction('fx_reval', { exchangeRate: 3.75, currencyId: 2 })} disabled={loading} variant="outline" className="w-full">
                        Run FX Revaluation
                    </Button>
                </Card>
                ...
                <Card className="p-6 space-y-4 border-t-4 border-t-indigo-400">
                    ...
                    <p className="text-sm text-gray-500">Calculates straight-line depreciation for all active fixed assets for this month.</p>
                    <Button onClick={() => handleAction('depreciation')} disabled={loading} variant="outline" className="w-full">
                ...
                <Card className="p-6 space-y-4 md:col-span-2 border-t-4 border-t-red-500 bg-red-50">
                    ...
                    <p className="text-sm text-red-600">Closes the selected month. No further journal entries can be posted or modified in this period.</p>
