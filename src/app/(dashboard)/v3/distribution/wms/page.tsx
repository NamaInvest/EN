...
import { PackageCheck, Search, Plus, Filter, Save } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto space-y-6 p-6">
            <div className="flex justify-between items-center bg-slate-900 text-white p-6 rounded-xl shadow-lg">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">Advanced WMS & Route Sales</h1>
                        <p className="text-slate-400 text-sm mt-1">3D Bin locations, B2B credit limits, and Tier-based volume pricing matrix.</p>
                    </div>
                </div>
