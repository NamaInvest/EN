    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="card p-6 border border-[var(--border)] bg-[var(--bg-secondary)] mb-6 rounded-xl shadow-sm">
        <div className="flex gap-2">
          <input 
            ...
            className="flex-1 p-3 border border-[var(--border)] rounded-lg bg-[var(--bg-primary)] text-[var(--text)] outline-none focus:ring-2 focus:ring-blue-500"
      ...
      {result && (
        <div className="card p-6 border border-[var(--border)] bg-[var(--bg-primary)] rounded-xl shadow-sm">
          ...
          <pre className="p-4 bg-gray-50 dark:bg-gray-900 border border-[var(--border)] rounded-lg overflow-auto text-sm" dir="ltr">
