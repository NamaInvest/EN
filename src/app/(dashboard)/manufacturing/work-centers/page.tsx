...
export default function WorkCentersPage() {
 ...
 <div>
 <label className="block text-sm text-slate-700 mb-1">اسم المركز (مثال: محطة اللحام)</label>
 ...
 <div>
 <label className="block text-sm text-slate-700 mb-1">الكود</label>
 ...
 <div>
 <label className="block text-sm text-slate-700 mb-1">تكلفة التشغيل للساعة (ريال)</label>
 ...
 <div>
 <label className="block text-sm text-slate-700 mb-1">السعة (Capacity)</label>
 ...
 <tr>
 <th className="px-6 py-3 text-slate-500 font-medium">اسم المركز</th>
 <th className="px-6 py-3 text-slate-500 font-medium">الكود</th>
 <th className="px-6 py-3 text-slate-500 font-medium">تكلفة الساعة</th>
 <th className="px-6 py-3 text-slate-500 font-medium">السعة</th>
 <th className="px-6 py-3 text-slate-500 font-medium">الحالة</th>
 </tr>
 </thead>
