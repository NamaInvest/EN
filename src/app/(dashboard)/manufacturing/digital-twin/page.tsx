...
export default function DigitalTwinPage() {
 ...
 <p className="text-slate-400 mt-1">{_t('التوأم الرقمي، وكلاء الذكاء الاصطناعي، دفتر الأستاذ Blockchain، المحاسبة بدون لمس', 'Digital Twin, AI Agents, Blockchain Ledger, Zero-Touch Accounting')}</p>
 </div>
 </div>
