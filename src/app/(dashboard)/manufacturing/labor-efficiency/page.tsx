...
export default function LaborEfficiencyPage() {
 ...
 <td className="px-6 py-4 font-bold text-slate-800">{row.orderNumber}</td>
 <td className="px-6 py-4 text-slate-600">{row.standardHours}</td>
 <td className="px-6 py-4 text-slate-600">{row.actualHours}</td>
