        ...
        <div className="p-6 h-[calc(100vh-64px)] flex flex-col bg-gray-50 dark:bg-gray-900">
            <div className="flex justify-between items-center pb-6 shrink-0">
                <div>
                    ...
                    <p className="text-gray-500 mt-1 text-sm">Automated invoice validation against PO and GRN (Purchase Order ↔ Receipt ↔ Invoice)</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6 shrink-0">
                <div className="bg-white dark:bg-gray-800 p-5 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
                    <p className="text-sm font-medium text-gray-500">Invoices Processed (30d)</p>
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white font-mono mt-1">458</h3>
                </div>
                <div className="bg-white dark:bg-gray-800 p-5 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
                    <p className="text-sm font-medium text-green-600 dark:text-green-400">Auto-Matched (No Variance)</p>
                ...
                <div className="bg-white dark:bg-gray-800 p-5 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
                    <p className="text-sm font-medium text-yellow-600 dark:text-yellow-400">Within Tolerance</p>
                ...
                <div className="bg-red-50 dark:bg-red-900/20 p-5 rounded-lg border border-red-200 dark:border-red-800 shadow-sm">
                    <p className="text-sm font-medium text-red-800 dark:text-red-400">Exceptions (On Hold)</p>
            ...
            <div className="flex-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm flex flex-col min-h-0">
                <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center bg-gray-50 dark:bg-gray-900/50">
                    <h3 className="text-lg font-medium text-gray-900 dark:text-white">Matching Exceptions queue</h3>
                    <div className="relative">
                        <Search className="w-4 h-4 absolute left-2 top-2 text-gray-400" />
                        <input type="text" placeholder="Search Supplier or Invoice..." className="pl-8 pr-3 py-1.5 text-sm border border-gray-300 rounded-md dark:bg-gray-800 dark:border-gray-600 dark:text-white" />
                    </div>
                </div>
                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead className="bg-gray-50 dark:bg-gray-900/50 sticky top-0 shadow-sm">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">PO Total</th>
                                <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">GRN Total</th>
                                <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Invoice Total</th>
                                <th className="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Hold Reason</th>
                            ...
                            <tr className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    <div className="flex justify-center space-x-2">
                                        <button className="p-1 rounded text-green-600 hover:bg-green-50 dark:hover:bg-green-900/30 tooltip" title="Force Approve (Override Tolerance)">
                                            <Check className="w-5 h-5" />
                                        </button>
                                        <button className="p-1 rounded text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 tooltip" title="Reject / Request Credit Note">
                                            <X className="w-5 h-5" />
                                        </button>
                                        <button className="p-1 rounded text-gray-500 hover:bg-gray-200 dark:hover:bg-gray-700 tooltip" title="View Details">
                            ...
                            <tr className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-center">
                                    <span className="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400">
                                        QTY_HOLD (Short Receipt)
                                    </span>
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    <div className="flex justify-center space-x-2">
                                        <button className="p-1 rounded text-green-600 hover:bg-green-50 dark:hover:bg-green-900/30">
                                            <Check className="w-5 h-5" />
                                        </button>
                                        <button className="p-1 rounded text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30">
                                            <X className="w-5 h-5" />
                                        </button>
                                        <button className="p-1 rounded text-gray-500 hover:bg-gray-200 dark:hover:bg-gray-700">
                                            <Eye className="w-5 h-5" />
                                        </button>
                                    </div>
                                </td>
