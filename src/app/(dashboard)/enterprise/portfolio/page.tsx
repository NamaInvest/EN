  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-6 flex items-center gap-2">
        <LayoutDashboard className="text-primary" /> Enterprise Portfolio
      </h1>
      ...
      {loading ? (
        ...
        <div className="card p-8 text-center border border-(--border) bg-(--bg-secondary) rounded-xl shadow-sm">
          ...
          <h2 className="text-lg font-bold mb-2">No Portfolios Found</h2>
          <p className="text-(--text-muted)">The enterprise portfolio view requires active multi-company projects to be initialized.</p>
        </div>
      )}
    </div>
  );
