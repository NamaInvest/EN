        ...
        <div className="p-6 animate-in slide-in-from-left-4 duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div className="bg-gradient-to-br from-indigo-50 to-blue-50 border p-6 rounded-2xl flex items-center gap-4 shadow-sm hover:shadow-md transition">
                    ...
                    <div>
                        <p className="text-sm font-bold text-gray-500">{t('sys.str_1936')}</p>
                ...
                <div className="bg-gradient-to-br from-emerald-50 to-green-50 border p-6 rounded-2xl flex items-center gap-4 shadow-sm hover:shadow-md transition">
                    ...
                    <div>
                        <p className="text-sm font-bold text-gray-500">{t('sys.str_1937')}</p>
                ...
                <div className="bg-gradient-to-br from-red-50 to-rose-50 border p-6 rounded-2xl flex items-center gap-4 shadow-sm hover:shadow-md transition">
                    ...
                    <div>
                        <p className="text-sm font-bold text-gray-500">{t('sys.str_1938')}</p>
            ...
            <div className="bg-white border rounded-2xl shadow-sm overflow-hidden min-h-[400px]">
                {!isLoaded ? (
                    ...
                    <div className="p-20 text-center text-gray-500">
                        ...
                        <p className="max-w-md mx-auto text-sm text-gray-400">{t('sys.str_1941')}</p>
                    </div>
                ) : (
                    <table className="w-full text-sm text-right">
                        <thead className="bg-[#f8f9fa] border-b">
                            <tr>
                                <th className="p-4 font-bold text-gray-600">{t('sys.str_1942')}</th>
                                <th className="p-4 font-bold text-gray-600">{t('sys.str_1943')}</th>
                                <th className="p-4 font-bold text-gray-600">{t('sys.str_1944')}</th>
                                <th className="p-4 font-bold text-gray-600">{t('sys.str_1945')}</th>
                                <th className="p-4 font-bold text-gray-600">{t('sys.str_1946')}</th>
                                <th className="p-4 font-bold text-gray-600">{t('sys.str_465')}</th>
                            </tr>
                        </thead>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden">
                        ...
                        <div className="p-6 space-y-4 text-right">
                            ...
                            <div className="p-4 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
                                <label className="block text-sm font-bold text-gray-700 mb-3">{t('sys.str_1952')}</label>
                            ...
                            <div>
                                <label className="block text-sm font-bold text-gray-700 mb-1">{t('sys.str_1955')}</label>
                                <textarea value={notes} onChange={e=>setNotes(e.target.value)} className="w-full border-2 border-gray-200 rounded-xl p-3 focus:border-indigo-600 outline-none h-24 resize-none" placeholder={t('sys.str_1957')}></textarea>
                            </div>

                            <div className="pt-4 flex justify-end gap-3 mt-4">
                                <button onClick={()=>setShowModal(false)} className="px-6 py-2.5 rounded-xl bg-gray-100 text-gray-700 font-bold hover:bg-gray-200 transition">{t('fin.str_206')}</button>
