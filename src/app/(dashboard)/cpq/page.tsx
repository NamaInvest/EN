 ...
 return (
   <div className="page-content" style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto', direction: 'rtl' }}>
     <h1 style={{ marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
       <DatabaseBackup size={24} color="var(--primary)" /> عروض الأسعار CPQ
     </h1>
     ...
     {loading ? (
       ...
       <FeatureDisabledPanel 
         moduleName="عروض الأسعار CPQ" 
         apiExists={false} 
         apiPath="/api/cpq" 
         missingFeatures="نظام التسعير المتقدم وتهيئة عروض الأسعار الديناميكية المعقدة (Configure Price Quote - CPQ) بالاعتماد على الفروع وفئات العملاء وعروض التخفيض النشطة."
