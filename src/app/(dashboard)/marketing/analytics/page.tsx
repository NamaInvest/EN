  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="card p-6 border border-(--) bg-(--) rounded-xl shadow-sm flex items-center gap-4">
          <div className="p-4 bg-blue-100 text-blue-600 rounded-lg"><Activity size={24} /></div>
          <div>
            <div className="text-sm text-(--)">Active Campaigns</div>
        ...
        <div className="card p-6 border border-(--) bg-(--) rounded-xl shadow-sm flex items-center gap-4">
          ...
          <div>
            <div className="text-sm text-(--)">New Leads</div>
            <div className="text-2xl font-bold text-(--)">---</div>
          </div>
        </div>
        <div className="card p-6 border border-(--) bg-(--) rounded-xl shadow-sm flex items-center gap-4">
          ...
          <div>
            <div className="text-sm text-(--)">Conversion Rate</div>
            <div className="text-2xl font-bold text-(--)">---</div>
          </div>
        </div>
      </div>

      <div className="card p-12 border border-(--) bg-(--) rounded-xl text-center shadow-sm">
