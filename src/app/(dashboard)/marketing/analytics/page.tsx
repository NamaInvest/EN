  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="card p-6 border border-[var(--border)] bg-[var(--bg-secondary)] rounded-xl shadow-sm flex items-center gap-4">
          <div className="p-4 bg-blue-100 text-blue-600 rounded-lg"><Activity size={24} /></div>
          <div>
            <div className="text-sm text-[var(--text-muted)]">Active Campaigns</div>
            <div className="text-2xl font-bold text-[var(--text)]">---</div>
          </div>
        </div>
        <div className="card p-6 border border-[var(--border)] bg-[var(--bg-secondary)] rounded-xl shadow-sm flex items-center gap-4">
      ...
      <div className="card p-12 border border-[var(--border)] bg-[var(--bg-primary)] rounded-xl text-center shadow-sm">
