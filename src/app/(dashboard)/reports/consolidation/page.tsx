...
export default function ConsolidationDashboard() {
 ...
 <div>
 <h1 className="text-3xl font-bold text-slate-800 tracking-tight">{_t('مركز قيادة التوحيد', 'Consolidation Command Center')}</h1>
 <p className="text-sm text-slate-500 mt-1">{_t('البيانات المالية والتصفية للمجموعة المتوافقة مع المعايير الدولية لإعداد التقارير المالية', 'IFRS Compliant Group Financials & Eliminations')}</p>
 </div>
 ...
 >
 <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>{_t('فترة القفل والنشر', 'Lock & Post Period')}</button>
 )}
 </div>
 </div>
 ...
 <h3 className="text-lg font-bold text-slate-800 mb-4">{_t('هيكل المجموعة', 'Group Structure')}</h3>
 ...
 <div>
 <p className="font-semibold text-slate-800 text-sm">{_t('مجموعة نماء القابضة', 'Nama Holding Group')}</p>
 ...
 <div>
 <p className="font-semibold text-slate-800 text-sm">{_t('نما تك (الإمارات العربية المتحدة)', 'Nama Tech (UAE)')}</p>
 ...
 <div>
 <p className="font-semibold text-slate-800 text-sm">{_t('نماء الطبية (مصر)', 'Nama Medical (Egypt)')}</p>
 ...
 <p className="text-sm font-medium text-slate-500 mb-2">{_t('مساهمة الأرباح الفرعية', 'Subsidiary Profit Contribution')}</p>
 ...
 <span className="text-lg font-bold text-slate-700">{_t('ر.س', 'SAR')}</span>
 </div>
 ...
 <p className="text-sm font-medium text-slate-500">{_t('نسبة التبعية بين الشركات', 'Intercompany Dependency Ratio')}</p>
 ...
 <p className="text-sm font-medium text-slate-500">{_t('تعديل ترجمة العملة (CTA)', 'Currency Translation Adj (CTA)')}</p>
 <p className="text-xl font-bold text-emerald-600 mt-1">+$14,200 <span className="text-xs text-slate-400 font-normal">{_t('في الأسهم', 'in Equity')}</span></p>
 </div>
 </div>
 </div>
 </div>
 ...
 <h3 className="text-lg font-bold text-slate-800 mb-6">{_t('عرض التباين الموحد', 'Consolidation Variance View')}</h3>
 <div className="overflow-x-auto">
 <table className="w-full text-left border-collapse">
 <thead>
 <tr className="border-b-2 border-slate-200">
 <th className="py-3 px-4 font-semibold text-slate-700">{_t('مجموعة الحساب', 'Account Group')}</th>
 <th className="py-3 px-4 font-semibold text-slate-700 text-right">{_t('المجموع المجمع (الإجمالي)', 'Combined Total (Gross)')}</th>
 <th className="py-3 px-4 font-semibold text-rose-600 text-right">{_t('عمليات التصفية', 'Eliminations')}</th>
 <th className="py-3 px-4 font-semibold text-emerald-700 text-right border-l border-slate-100">{_t('الإجمالي الموحد (الصافي)', 'Consolidated Total (Net)')}</th>
 </tr>
 </thead>
 ...
 <tr className="hover:bg-slate-50">
 <td className="py-4 px-4 text-sm font-medium text-slate-800">{_t('تكلفة البضائع المباعة (COGS)', 'Cost of Goods Sold (COGS)')}</td>
 ...
 <td className="py-4 px-4 text-sm font-bold text-indigo-900">{_t('صافي الدخل', 'Net Income')}</td>
