...
export default function ConsolidationDashboard() {
 ...
 <div>
 <h1 className="text-3xl font-bold text-slate-800 tracking-tight">{_t('Consolidation Command Center', 'Consolidation Command Center')}</h1>
 <p className="text-sm text-slate-500 mt-1">{_t('IFRS Compliant Group Financials & Eliminations', 'IFRS Compliant Group Financials & Eliminations')}</p>
 </div>
 ...
 >
 <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>{_t('Lock & Post Period', 'Lock & Post Period')}</button>
 )}
 </div>
 </div>
 ...
 <h3 className="text-lg font-bold text-slate-800 mb-4">{_t('Group Structure', 'Group Structure')}</h3>
 ...
 <div>
 <p className="font-semibold text-slate-800 text-sm">{_t('Nama Holding Group', 'Nama Holding Group')}</p>
 ...
 <div>
 <p className="font-semibold text-slate-800 text-sm">{_t('Nama Tech (UAE)', 'Nama Tech (UAE)')}</p>
 ...
 <div>
 <p className="font-semibold text-slate-800 text-sm">{_t('Nama Medical (Egypt)', 'Nama Medical (Egypt)')}</p>
 ...
 <p className="text-sm font-medium text-slate-500 mb-2">{_t('Subsidiary Profit Contribution', 'Subsidiary Profit Contribution')}</p>
 ...
 <p className="text-sm font-medium text-slate-500">{_t('Intercompany Dependency Ratio', 'Intercompany Dependency Ratio')}</p>
 ...
 <p className="text-sm font-medium text-slate-500">{_t('Currency Translation Adj (CTA)', 'Currency Translation Adj (CTA)')}</p>
 <p className="text-xl font-bold text-emerald-600 mt-1">+$14,200 <span className="text-xs text-slate-400 font-normal">{_t('in Equity', 'in Equity')}</span></p>
 </div>
 </div>
 </div>
 </div>
 ...
 <h3 className="text-lg font-bold text-slate-800 mb-6">{_t('Consolidation Variance View', 'Consolidation Variance View')}</h3>
 <div className="overflow-x-auto">
 <table className="w-full text-left border-collapse">
 <thead>
 <tr className="border-b-2 border-slate-200">
 <th className="py-3 px-4 font-semibold text-slate-700">{_t('Account Group', 'Account Group')}</th>
 <th className="py-3 px-4 font-semibold text-slate-700 text-right">{_t('Combined Total (Gross)', 'Combined Total (Gross)')}</th>
 <th className="py-3 px-4 font-semibold text-rose-600 text-right">{_t('Eliminations', 'Eliminations')}</th>
 <th className="py-3 px-4 font-semibold text-emerald-700 text-right border-l border-slate-100">{_t('Consolidated Total (Net)', 'Consolidated Total (Net)')}</th>
 </tr>
 </thead>
 ...
 <tr className="hover:bg-slate-50">
 <td className="py-4 px-4 text-sm font-medium text-slate-800">{_t('Cost of Goods Sold (COGS)', 'Cost of Goods Sold (COGS)')}</td>
 ...
 <td className="py-4 px-4 text-sm font-bold text-indigo-900">{_t('Net Income', 'Net Income')}</td>
