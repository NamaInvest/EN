...
const MODULES_DATA = [
  ...
  { cat: 'finance', path: '/receipt-vouchers', icon: 'FileText', title: 'سندات القبض والدفع המקדמה', desc: 'إدارة متطورة لسندات وتتبع المديونيات، ودفعات مقدمة لتخصيص الإيراد عبر فواتير.', detailedDesc: 'سندات تتمتع بالذكاء يمكنها تسديد 10 سحوبات أو فواتير للعميل من مبالغ السند في نفس شاشة التحصيل بدون أعباء توجيه إضافية.', features: ['سند مالية واحد يسدد مجموعة غير محدودة من المبيعات لعميل جملة لتوفير الوقت', 'اقتطاع وحساب الضريبة المقتطعة خصم واضافة من المورد مقدماً لسلامة الإقرار', 'دعم وسائل وقنوات دفع متنوعة (مدى شبكات، Apple Pay، حوالة) داخل السند الفردي', 'نظام موافقات ممتد للسندات ذات المبالغ المصيرية قبل استنزاف واقتطاع البنك'] },
