    ...
    return (
        <div className="p-6 space-y-6">
            <div className="flex justify-between items-center">
                ...
                <Button>{_t('+ إنشاء جديد لوحة القيادة', '+ Create New Dashboard')}</Button>
            </div>
                    ...
                    <Card key={idx} className="hover:border-blue-500 transition-colors cursor-pointer">
                        ...
                        <CardContent>
                            ...
                            <div className="text-xs text-gray-400 flex justify-between items-center">
                                ...
                                <Button size="sm" variant="ghost" className="text-blue-600 hover:text-blue-800 hover:bg-blue-50">{_t('تحرير التخطيط', 'Edit Layout')}</Button>
                            </div>
                        </CardContent>
                    </Card>
                ))}
