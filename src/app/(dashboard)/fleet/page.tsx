...
export default function FleetDashboard() {
 ...
 <h3 className="text-3xl font-bold text-slate-900 font-[Fira_Code]">42/45</h3>
 </div>
 ...
 <h3 className="text-3xl font-bold text-slate-900 font-[Fira_Code]">12,450 ﷼</h3>
 </div>
 ...
 <h3 className="text-3xl font-bold text-slate-900 font-[Fira_Code]">8,240 كم</h3>
 </div>
 ...
 <h3 className="text-3xl font-bold text-slate-900 font-[Fira_Code]">3 مركبات</h3>
 </div>
 ...
 <h2 className="text-lg font-bold text-slate-900 ">حالة المركبات المباشرة</h2>
 ...
 className="pl-4 pr-10 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-sm focus:outline-none focus:border-indigo-500 transition-colors w-64"
 />
 </div>
 </div>
 ...
 <div className="bg-white dark:bg-[#0F172A] p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
 <h2 className="text-lg font-bold text-slate-900 mb-4">آخر الرحلات المنفذة</h2>
