        ...
        <div className="p-6 space-y-6">
            <div className="flex justify-between items-center border-b border-gray-200 dark:border-gray-700 pb-4">
                <div>
                    ...
                    <p className="text-gray-500 mt-1 text-sm">Generate SIF files and track bank uploads for SAMA & Mudad compliance</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                <div className="bg-white dark:bg-gray-800 p-5 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm flex items-center">
                    ...
                    <div>
                        <p className="text-sm font-medium text-gray-500">Total SIF Batches</p>
                ...
                <div className="bg-white dark:bg-gray-800 p-5 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm flex items-center">
                    ...
                    <div>
                        <p className="text-sm font-medium text-gray-500">Accepted by Mudad</p>
                ...
                <div className="bg-white dark:bg-gray-800 p-5 rounded-lg border border-red-200 dark:border-red-900 shadow-sm flex items-center bg-red-50 dark:bg-red-900/10">
                    ...
                    <div>
                        <p className="text-sm font-medium text-red-800 dark:text-red-400">IBAN Errors</p>
            ...
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm">
                <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                    <h2 className="text-lg font-medium text-gray-900 dark:text-white">Recent WPS Batches</h2>
                </div>
                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            <tr className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-blue-600">WPS-2024-05-8821</td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-300">May 2024</td>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <button className="text-blue-600 hover:text-blue-900 dark:hover:text-blue-400 mr-3 flex items-center justify-end w-full">
                                        <Download className="w-4 h-4 mr-1" /> SIF File
                                    </button>
                                </td>
                            </tr>
                            <tr className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-blue-600">WPS-2024-04-1093</td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-300">April 2024</td>
