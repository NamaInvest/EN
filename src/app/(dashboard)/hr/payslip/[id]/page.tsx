...
export default function PayslipViewer() {
 ...
 <h2 className="text-4xl font-black text-slate-200 uppercase tracking-widest mb-2">{_t('قسيمة الدفع', 'Payslip')}</h2>
 ...
 <p className="text-slate-300 text-xs">{_t('صافي الأجر (ريال سعودي)', 'Net Pay (SAR)')}</p>
 </div>
 ...
 <p className="mt-1 font-mono">{_t('هذا عبارة عن قسيمة دفع تم إنشاؤها بواسطة النظام ولا تتطلب التوقيع.', 'This is a system generated payslip and does not require a signature.')}</p>
 </div>
