...
export default function CashFlowDashboard() {
 ...
 <TrendingUp className="w-8 h-8 mr-3 text-green-600" />{_t('توقعات التدفق النقدي', 'Cash Flow Forecast')}</h1>
 ...
 <Filter className="w-4 h-4 mr-2" />{_t('تصفية الحسابات', 'Filter Accounts')}</button>
 <select className="px-4 py-2 border border-slate-300 rounded-md shadow-sm text-sm font-medium text-slate-700 bg-white ">
 <option>{_t('الثلاثين يومًا القادمة', 'Next 30 Days')}</option>
 <option>{_t('الـ 90 يومًا القادمة', 'Next 90 Days')}</option>
 <option>{_t('الستة أشهر القادمة', 'Next 6 Months')}</option>
 </select>
 </div>
 </div>
 ...
 <div>
 <p className="text-sm font-medium text-slate-500">{_t('السيولة الحالية (جميع البنوك)', 'Current Liquidity (All Banks)')}</p>
 ...
 <div className="bg-white p-5 rounded-lg border border-slate-200 shadow-sm flex items-center justify-between">
 <div>
 <p className="text-sm font-medium text-slate-500">{_t('التدفقات المتوقعة (30 يومًا القادمة)', 'Expected Inflows (Next 30d)')}</p>
 ...
 <div className="bg-white p-5 rounded-lg border border-slate-200 shadow-sm flex items-center justify-between">
 <div>
 <p className="text-sm font-medium text-slate-500">{_t('التدفقات الخارجة المتوقعة (30 يومًا القادمة)', 'Expected Outflows (Next 30d)')}</p>
 ...
 <h3 className="text-lg font-medium text-slate-900 mb-4">{_t('الوضع النقدي المتوقع', 'Projected Cash Position')}</h3>
 ...
 <h3 className="text-lg font-medium text-slate-900 ">{_t('الالتزامات والإيصالات القادمة', 'Upcoming Obligations & Receipts')}</h3>
 </div>
 ...
 <th className="px-6 py-3 text-right text-xs font-medium text-slate-500 uppercase tracking-wider">{_t('المبلغ (ريال سعودي)', 'Amount (SAR)')}</th>
 <th className="px-6 py-3 text-center text-xs font-medium text-slate-500 uppercase tracking-wider">{_t('احتمال', 'Probability')}</th>
 </tr>
 </thead>
 ...
 <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400">{_t('فاتورة AP مستحقة', 'AP Invoice Due')}</span>
 </td>
 ...
 <td className="px-6 py-4 whitespace-nowrap text-sm">
 <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400">{_t('فاتورة AR مستحقة', 'AR Invoice Due')}</span>
 </td>
 ...
 <td className="px-6 py-4 whitespace-nowrap text-sm">
 <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400">{_t('تشغيل الرواتب', 'Payroll Run')}</span>
 </td>
