...
export default function CashFlowDashboard() {
 ...
 <div>
 <p className="text-sm font-medium text-slate-500">Current Liquidity (All Banks)</p>
 ...
 <div className="bg-white p-5 rounded-lg border border-slate-200 shadow-sm flex items-center justify-between">
 <div>
 <p className="text-sm font-medium text-slate-500">Expected Inflows (Next 30d)</p>
 ...
 <div className="bg-white p-5 rounded-lg border border-slate-200 shadow-sm flex items-center justify-between">
 <div>
 <p className="text-sm font-medium text-slate-500">Expected Outflows (Next 30d)</p>
 ...
 <h3 className="text-lg font-medium text-slate-900 mb-4">Projected Cash Position</h3>
 ...
 <h3 className="text-lg font-medium text-slate-900 ">Upcoming Obligations & Receipts</h3>
 </div>
 ...
 <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-500">Estimated May 2026 Salaries</td>
