...
export default function BankReconciliation() {
 ...
 <div className="bg-white p-5 rounded-lg border border-slate-200 shadow-sm text-center">
 <p className="text-sm font-medium text-slate-500">GL Book Balance</p>
 ...
 {loading && <p className="text-center p-4 text-slate-500">Loading statements...</p>}
 ...
 <h4 className="text-lg font-medium text-slate-900 mb-4">Suggested Match</h4>
 ...
 <p className="text-sm text-slate-800 font-medium">Al Sharq Company LLC</p>
 ...
 <button className="w-full py-2 mt-2 bg-white border border-slate-300 hover:bg-slate-50 dark:hover:bg-gray-700 text-slate-700 font-medium rounded-md">
 Search Manually
 </button>
 </div>
 </div>
