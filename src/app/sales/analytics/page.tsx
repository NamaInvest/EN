        ...
        <div className="min-h-screen p-6" dir="rtl">
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-[var(--text-muted)] text-sm mt-1">مؤشرات المبيعات + الفرق + المندوبون + المنتجات</p>
                </div>
                            ...
                            <div key={t.name} className="card p-5">
                                <div className="flex items-center justify-between mb-3">
                                    <div>
                                        ...
                                        <p className="text-xs text-[var(--text-secondary)]">أفضل مندوب: {t.topRep} • {t.reps} مندوبين</p>
                                    </div>
                                    <div className="text-left">
                                        <p className="text-lg font-bold text-[var(--text)]">{t.actual.toLocaleString()} ر.س</p>
