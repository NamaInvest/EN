    ...
    try {
        ...
        if (action === 'onboard') {
            ...
            try {
                ...
                console.log('✅ Compliance CSID obtained, request_id:', compliance_rid);
                ...
                console.log('✅ Test invoice signed');
                ...
                console.error('ZATCA Onboarding Error:', onboardErr.message, onboardErr.stack);
                return NextResponse.json({ 
        ...
        console.error('ZATCA Onboard API error:', error);
