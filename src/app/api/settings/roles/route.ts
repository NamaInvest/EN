...
export const GET = withRoute(async ({ req }) => _GET(req as any), { rateLimit: 'DEFAULT', roles: ['admin', 'owner'] });

export const POST = withRoute(async ({ req }) => _POST(req as any), { rateLimit: 'DEFAULT', roles: ['admin', 'owner'] });
