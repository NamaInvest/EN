...
export const metadata: Metadata = {
  title: 'نظام ط¥ط¯ط§ط±ط© ط§ظ„طµظٹط¯ظ„ظٹط§طھ | ظ†ظ…ط§ ط¥ظ†ظپط³طھ â€” Pharmacy Management System',
  description: 'نظام ظ…طھظƒط§ظ…ظ„ ظ„ط¥ط¯ط§ط±ط© ط§ظ„طµظٹط¯ظ„ظٹط§طھ: طھطھط¨ط¹ طھظˆط§ط±ظٹط® ط§ظ„طµلاط­ظٹط© (FEFO)طŒ ظ…ظ†ط¹ بيع ط§ظ„ط¯ظˆط§ط، ط§ظ„منتهيطŒ ط¥ط¯ط§ط±ط© ط§ظ„ط¨ط¯ط§ط¦ظ„ ط§ظ„ط·ط¨ظٹط©طŒ ظˆط§ظ„ط£ط±ظ‚ط§ظ… ط§ظ„طھط³ظ„ط³ظ„ظٹط©. The most advanced pharmacy ERP in Saudi Arabia.',
  keywords: 'نظام طµظٹط¯ظ„ظٹط©, ط¨ط±ظ†ط§ظ…ط¬ طµظٹط¯ظ„ظٹط©, ط¥ط¯ط§ط±ط© ط£ط¯ظˆظٹط©, طھظˆط§ط±ظٹط® ط§ظ†طھظ‡ط§ط، ط§ظ„طµلاط­ظٹط©, FEFO, pharmacy management system, Saudi Arabia pharmacy software',
};

const features = [
  { icon: <Hourglass size={20}/>, title: 'طھطھط¨ط¹ طھظˆط§ط±ظٹط® ط§ظ„طµلاط­ظٹط© FEFO', desc: 'ظٹط³طھط­ظٹظ„ ط¨ط±ظ…ط¬ظٹط§ظ‹ طھظ…ط±ظٹط± فاتورة ط¨ط¯ظˆط§ط، منتهي ط§ظ„طµلاط­ظٹط©. النظام ظٹط·ط¨ظ‚ First-Expired-First-Out طھظ„ظ‚ط§ط¦ظٹط§ظ‹.' },
  { icon: <ShieldCheck size={20}/>, title: 'ظ…ظ†ط¹ بيع ط§ظ„ط£ط¯ظˆظٹط© ط§ظ„منتهيط©', desc: 'ط­ظ…ط§ظٹط© ط·ط¨ظ‚ظٹط© ظƒط§ظ…ظ„ط© ظ…ظ† الكاشير ظ„ظ…ظ†ط¹ ط£ظٹ منتج منتهي ط§ظ„طµلاط­ظٹط© ظ…ظ† ط§ظ„ظˆطµظˆظ„ ظ„ظ„عميل.' },
  { icon: <Pill size={20}/>, title: 'ط¥ط¯ط§ط±ط© ط§ظ„ط¨ط¯ط§ط¦ظ„ ط§ظ„ط·ط¨ظٹط©', desc: 'ظ‚ط§ط¹ط¯ط© ط¨ظٹط§ظ†ط§طھ ط§ظ„ط¨ط¯ط§ط¦ظ„ ط§ظ„ط¹ظ„ظ…ظٹط©. ظٹظ‚طھط±ط­ الكاشير ط§ظ„ط¨ط¯ظٹظ„ ظپظˆط±ط§ظ‹ ط¹ظ†ط¯ ظ†ظپط§ط° ط§ظ„ط¯ظˆط§ط، ط§ظ„ط£طµظ„ظٹ.' },
  { icon: <Hash size={20}/>, title: 'ط§ظ„ط£ط±ظ‚ط§ظ… ط§ظ„طھط³ظ„ط³ظ„ظٹط© ظ„ظ„ط£ط¯ظˆظٹط©', desc: 'طھطھط¨ط¹ ظƒظ„ ظˆط­ط¯ط© ط¯ظˆط§ط، ظ…ظ† ط§ظ„ظ…ظˆط±ط¯ ط¥ظ„ظ‰ العميل ط¹ط¨ط± Serial Number ظپط±ظٹط¯ â€” ط­ظ…ط§ظٹط© ط¶ط¯ ط§ظ„طھط²ظˆظٹط±.' },
  { icon: <Barcode size={20}/>, title: 'ط¨ط§ط±ظƒظˆط¯ ط³ط±ظٹط¹ ظˆط¯ظ‚ظٹظ‚', desc: 'ظ…ط³ط­ الباركود ط®لاظ„ 0.3 ط«ط§ظ†ظٹط© ظ…ط¹ عرض ظ…ط¹ظ„ظˆظ…ط§طھ ط§ظ„ط¯ظˆط§ط، ظƒط§ظ…ظ„ط©: ط§ظ„سعرطŒ ط§ظ„طµلاط­ظٹط©طŒ ظˆالمخزون.' },
  { icon: <BarChart3 size={20}/>, title: 'تقارير ظ…ط®ط²ظˆظ† ط¯ظˆط§ط¦ظٹط©', desc: 'تقارير ظ…طھط®طµطµط©: ط§ظ„ط£ط¯ظˆظٹط© ط¹ظ„ظ‰ ظˆط´ظƒ ط§لاظ†طھظ‡ط§ط،طŒ ط§ظ„ط£ظƒط«ط± ظ…بيعط§ظ‹طŒ ظ‡ط§ظ…ط´ ط§ظ„ط±ط¨ط­ ظ„ظƒظ„ طµظ†ظپطŒ ظˆظ…ط¹ط¯ظ„ ط§ظ„ط¯ظˆط±ط§ظ†.' },
  { icon: <FileText size={20}/>, title: 'فاتورة ZATCA ط¥ظ„ظƒطھط±ظˆظ†ظٹط©', desc: 'ط¥طµط¯ط§ط± ط§ظ„ظپظˆط§طھظٹط± ط§ظ„ط¥ظ„ظƒطھط±ظˆظ†ظٹط© ط§ظ„ظ…طھظˆط§ظپظ‚ط© ظ…ط¹ ط§ظ„ظ…ط±ط­ظ„ط© ط§ظ„ط«ط§ظ†ظٹط© ظ„ظ‡ظٹط¦ط© ط§ظ„ط²ظƒط§ط© ظˆط§ظ„ضريبة ظˆط§ظ„ط¬ظ…ط§ط±ظƒ.' },
  ...
  return (
    <div className="min-h-screen" dir="rtl" style={{ fontFamily: "'Lateef', sans-serif", background: '#F8FAFC' }}>
      ...
      <div className="bg-gradient-to-br from-emerald-900 via-teal-900 to-slate-900 text-white py-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-black mb-4 leading-tight">
            ط£ط¯ط± طµظٹط¯ظ„ظٹطھظƒ ط¨ط¯ظ‚ط© طµظٹط¯لاظ†ظٹط©
            <br/>
            <span className="text-emerald-300 text-3xl md:text-4xl">ظˆط¯ط§ط¹ط§ظ‹ ظ„ط£ط®ط·ط§ط، المخزون</span>
          </h1>
          ...
          <p className="text-slate-300 text-base mb-10 max-w-2xl mx-auto">
            نظام ظ†ظ…ط§ ط¥ظ†ظپط³طھ ظٹظˆظپط± طھط­ظƒظ…ط§ظ‹ ظƒط§ظ…لاظ‹ ظپظٹ ط§ظ„ط£ط¯ظˆظٹط©طŒ طھطھط¨ط¹ط§ظ‹ ط¯ظ‚ظٹظ‚ط§ظ‹ ظ„طھظˆط§ط±ظٹط® ط§لاظ†طھظ‡ط§ط،طŒ ظˆنقاط بيع ظپط§ط¦ظ‚ط© ط§ظ„ط³ط±ط¹ط© ظ„ط®ط¯ظ…ط© ط¹ظ…لاط¦ظƒ ظپظٹ ط«ظˆط§ظ†ظچ.
          </p>
      ...
      <div className="bg-gradient-to-br from-emerald-900 to-teal-900 text-white py-16 px-4 text-center">
        ...
        <p className="text-emerald-200 mb-8">تواصل ظ…ط¹ظ†ط§ ط§ظ„ظٹظˆظ… ظ„ظ„ط­طµظˆظ„ ط¹ظ„ظ‰ عرض طھظˆط¶ظٹط­ظٹ مجاني</p>
        <div className="flex flex-wrap justify-center gap-4">
