...
export const metadata: Metadata = {
  title: 'نظام ط¥ط¯ط§ط±ط© ط§ظ„طھظ…ظˆظٹظ†ط§طھ ظˆط§ظ„ط­ظ„ظˆظٹط§طھ | ظ†ظ…ط§ ط¥ظ†ظپط³طھ â€” Grocery & Retail ERP',
  description: 'نظام ظ…طھظƒط§ظ…ظ„ ظ„ظ„طھظ…ظˆظٹظ†ط§طھ ظˆط§ظ„ط­ظ„ظˆظٹط§طھ ظˆظ…ط­لاطھ ط§ظ„ط¨ظ‚ط§ظ„ط©: ط¥ط¯ط§ط±ط© ط¢لاظپ ط§ظ„ط£طµظ†ط§ظپطŒ ط§ظ„ظ…ظˆط§ط²ظٹظ† ط§ظ„ط¥ظ„ظƒطھط±ظˆظ†ظٹط©طŒ نقاط ط§ظ„ظˆلاط،طŒ ظˆالباركود. Best grocery retail management software in Saudi Arabia.',
  keywords: 'نظام طھظ…ظˆظٹظ†ط§طھ, ط¨ط±ظ†ط§ظ…ط¬ ط¨ظ‚ط§ظ„ط©, نظام ط­ظ„ظˆظٹط§طھ, ط¥ط¯ط§ط±ط© ظ…ط­ظ„, POS طھظ…ظˆظٹظ†ط§طھ, grocery management system, retail ERP Saudi Arabia, barcode system',
};

const features = [
  { icon: <LayoutDashboard size={20}/>, title: 'ط¥ط¯ط§ط±ط© ط¢لاظپ ط§ظ„ط£طµظ†ط§ظپ', desc: 'ظ…ط¹ط§ظ„ط¬ط© 120 طµظ†ظپط§ظ‹ ظپظٹ ط§ظ„ط¯ظ‚ظٹظ‚ط© ط¨ط¯ظ‚ط© ظƒط§ظ…ظ„ط©. ظ‡ظٹظƒظ„ط© ظ‡ط±ظ…ظٹط© ظ„ظ„ط£طµظ†ط§ظپ: ظپط¦ط©طŒ ظ…ط¬ظ…ظˆط¹ط©طŒ ظˆطµظ†ظپ ظپط±ط¹ظٹ.' },
  { icon: <Scale size={20}/>, title: 'ط±ط¨ط· ط§ظ„ظ…ظˆط§ط²ظٹظ† ط§ظ„ط¥ظ„ظƒطھط±ظˆظ†ظٹط©', desc: 'طھظƒط§ظ…ظ„ ظ…ط¨ط§ط´ط± ظ…ط¹ ط§ظ„ظ…ظˆط§ط²ظٹظ† ظ„بيع المنتجط§طھ ط¨ط§ظ„ظˆط²ظ† (ظƒظٹظ„ظˆ/ط¬ط±ط§ظ…) ظ…ط¹ ط§ط­طھط³ط§ط¨ ط§ظ„سعر طھظ„ظ‚ط§ط¦ظٹط§ظ‹.' },
  { icon: <Award size={20}/>, title: 'نظام ط§ظ„ظˆلاط، ظˆط§ظ„ط®طµظˆظ…ط§طھ', desc: 'نقاط ظˆلاط، طھظ„ظ‚ط§ط¦ظٹط© ظ„ظƒظ„ ط¹ظ…ظ„ظٹط© ط´ط±ط§ط،طŒ ط¹ط±ظˆط¶ "ط§ط´طھط±ظٹ 2 ظˆط§ط­طµظ„ ط¹ظ„ظ‰ 1"طŒ ظˆظƒظˆط¨ظˆظ†ط§طھ ط®طµظ… ط­طµط±ظٹط©.' },
  { icon: <BellRing size={20}/>, title: 'طھظ†ط¨ظٹظ‡ط§طھ ط§ظ„ظ†ظ‚طµ ط§ظ„ط°ظƒظٹط©', desc: 'ط±ط§ط¯ط§ط± ط°ظƒظٹ ظٹط±ط§ظ‚ط¨ المخزون ظ„ط­ط¸ظٹط§ظ‹ ظˆظٹظڈظ†ط¨ظ‘ظ‡ ظپظˆط± ط§ظ‚طھط±ط§ط¨ ط£ظٹ طµظ†ظپ ظ…ظ† ط§ظ„ط­ط¯ ط§ظ„ط£ط¯ظ†ظ‰.' },
  { icon: <Barcode size={20}/>, title: 'ط¨ط§ط±ظƒظˆط¯ ط§ظ„ظ…ظٹط²ط§ظ† ط§ظ„ظ…طھظ‚ط¯ظ…', desc: 'ط¯ط¹ظ… ظƒط§ظ…ظ„ ظ„ظ„ط¨ط§ط±ظƒظˆط¯ ط§ظ„ظ…طھط؛ظٹط± (Variable Weight Barcode) ط§ظ„ط®ط§طµ ط¨منتجط§طھ ط§ظ„ظ„ط­ظˆظ… ظˆط§ظ„ط¬ط¨ظ† ظˆط§ظ„ط­ظ„ظˆظٹط§طھ.' },
  { icon: <Tag size={20}/>, title: 'طباعة ط§ظ„ظ…ظ„طµظ‚ط§طھ ط§ظ„ط¬ظ…ط§ط¹ظٹط©', desc: 'طباعة ظ…ظ„طµظ‚ط§طھ ط£ط³ط¹ط§ط± ظˆط¨ط§ط±ظƒظˆط¯ ط¬ظ…ط§ط¹ظٹط© ط¨طھظ†ط³ظٹظ‚ط§طھ EAN/QR/Code128 ظ„ظ…ط¦ط§طھ ط§ظ„ط£طµظ†ط§ظپ ط¯ظپط¹ط© ظˆط§ط­ط¯ط©.' },
  { icon: <ShoppingBag size={20}/>, title: 'ط¬ط±ط¯ ط³ط±ظٹط¹ ظˆط¢ظ„ظٹ', desc: 'ط¯ظˆط±ط© ط¬ط±ط¯ ظ…طھظƒط§ظ…ظ„ط©: طھط®ط·ظٹط·طŒ طھط¹ط¯ط§ط¯ ط¨ط§ظ„ظƒط§ظ…ظٹط±ط§ ط£ظˆ الباركودطŒ ظˆط§ظƒطھط´ط§ظپ ط§ظ„ظپظˆط§ط±ظ‚ ظپظˆط±ط§ظ‹.' },
  { icon: <CheckCircle size={20}/>, title: 'تقارير ط§ظ„مبيعات ط§ظ„ظٹظˆظ…ظٹط©', desc: 'طھظ‚ط±ظٹط± ظٹظˆظ…ظٹ طھظپطµظٹظ„ظٹ: ط£ظƒط«ط± ط§ظ„ط£طµظ†ط§ظپ ظ…بيعط§ظ‹طŒ ظ‡ط§ظ…ط´ ط§ظ„ط±ط¨ط­طŒ ظˆظ…ظ‚ط§ط±ظ†ط© ط§ظ„ط£ط¯ط§ط، ط§ظ„ط£ط³ط¨ظˆط¹ظٹ.' },
];
  ...
  return (
    <div className="min-h-screen" dir="rtl" style={{ fontFamily: "'Lateef', sans-serif", background: '#F8FAFC' }}>
      ...
      <div className="bg-gradient-to-br from-amber-900 via-orange-900 to-slate-900 text-white py-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-black mb-4 leading-tight">
            طھط­ظƒظ… ظپظٹ ط¢لاظپ ط§ظ„ط£طµظ†ط§ظپ
            <br/>
          ...
          <p className="text-slate-300 text-base mb-10 max-w-2xl mx-auto">
            ط³ظˆط§ط، ظƒظ†طھ طھط¯ظٹط± ط³ظˆط¨ط± ظ…ط§ط±ظƒطھ ط¶ط®ظ… ط£ظˆ ظ…ط­ظ„ ط­ظ„ظˆظٹط§طھ ظپط§ط®ط±طŒ نظامظ†ط§ ظٹط¶ظ…ظ† ظ„ظƒ ط¬ط±ط¯ط§ظ‹ ظ„ط­ط¸ظٹط§ظ‹ ظˆمبيعات لا طھطھظˆظ‚ظپ.
          </p>
      ...
      <div className="bg-gradient-to-br from-amber-900 to-orange-900 text-white py-16 px-4 text-center">
        ...
        <p className="text-amber-200 mb-8">تواصل ظ…ط¹ظ†ط§ ظ„ظ„ط­طµظˆظ„ ط¹ظ„ظ‰ عرض طھظˆط¶ظٹط­ظٹ مجاني</p>
        <div className="flex flex-wrap justify-center gap-4">
