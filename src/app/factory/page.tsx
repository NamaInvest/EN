...
export const metadata: Metadata = {
  title: 'نظام ط¥ط¯ط§ط±ط© ط§ظ„ظ…طµط§ظ†ط¹ ظˆط§ظ„طھطµظ†ظٹط¹ | ظ†ظ…ط§ ط¥ظ†ظپط³طھ â€” Manufacturing ERP System',
  description: 'نظام طھط®ط·ظٹط· موارد ط§ظ„ظ…طµط§ظ†ط¹: ظ‚ط§ط¦ظ…ط© ط§ظ„ظ…ظˆط§ط¯ BOMطŒ طھطھط¨ط¹ ط®ط·ظˆط· ط§ظ„ط¥ظ†طھط§ط¬طŒ ط­ط³ط§ط¨ طھظƒظ„ظپط© ط§ظ„طھطµظ†ظٹط¹طŒ MRPطŒ ظˆط¥ط¯ط§ط±ط© ط§ظ„ظ‡ط§ظ„ظƒ. Advanced manufacturing ERP for Saudi factories.',
  keywords: 'نظام ظ…طµظ†ط¹, ط¥ط¯ط§ط±ط© ط¥ظ†طھط§ط¬, BOM, MRP, طھظƒظ„ظپط© طھطµظ†ظٹط¹, manufacturing ERP, production management Saudi Arabia, factory management system, ظ‚ط§ط¦ظ…ط© ط§ظ„ظ…ظˆط§ط¯',
};

const features = [
  { icon: <BookOpen size={20}/>, title: 'ظ‚ط§ط¦ظ…ط© ط§ظ„ظ…ظˆط§ط¯ (BOM)', desc: 'طھط­ط¯ظٹط¯ ط¯ظ‚ظٹظ‚ ظ„ظƒظ„ ظ…ظƒظˆظ†ط§طھ المنتج ط¨ط§ظ„ظƒظ…ظٹط§طھ ط§ظ„ط¯ظ‚ظٹظ‚ط©. طھط¯ط§ط®ظ„ BOM ظ…طھط¹ط¯ط¯ط© ط§ظ„ظ…ط³طھظˆظٹط§طھ ظ„منتجط§طھ ط§ظ„طھط¬ظ…ظٹط¹ ط§ظ„ظ…ط¹ظ‚ط¯ط©.' },
  { icon: <Activity size={20}/>, title: 'طھطھط¨ط¹ ظ…ط±ط§ط­ظ„ ط§ظ„ط¥ظ†طھط§ط¬', desc: 'ظ…ط±ط§ظ‚ط¨ط© المنتج ط¹ط¨ط± ظƒظ„ ظ…ط±ط§ط­ظ„ ط§ظ„طھطµظ†ظٹط¹: ط§ظ„ظ…ظˆط§ط¯ ط§ظ„ط®ط§ظ…طŒ ظ…ط¹ط§ظ„ط¬ط©طŒ طھط¬ظ…ظٹط¹طŒ ظپط­طµطŒ ظˆطھط؛ظ„ظٹظپ â€” ظپظٹ ط§ظ„ظˆظ‚طھ ط§ظ„ظپط¹ظ„ظٹ.' },
  { icon: <DollarSign size={20}/>, title: 'ط­ط³ط§ط¨ طھظƒظ„ظپط© ط§ظ„طھطµظ†ظٹط¹', desc: 'ط§ظ„طھظƒظ„ظپط© ط§ظ„ط­ظ‚ظٹظ‚ظٹط© = ظ…ظˆط§ط¯ ط®ط§ظ… + ط¹ظ…ط§ظ„ط© ظ…ط¨ط§ط´ط±ط© + طھظƒط§ظ„ظٹظپ طھط´ط؛ظٹظ„. ط¯ظ‚ط© ظ…طھظ†ط§ظ‡ظٹط© ظ„ظƒظ„ ظˆط­ط¯ط© منتجط©.' },
  { icon: <Cpu size={20}/>, title: 'طھط®ط·ظٹط· ط§ظ„موارد MRP', desc: 'ط­ط³ط§ط¨ ط§لاط­طھظٹط§ط¬ ظ…ظ† ط§ظ„ظ…ظˆط§ط¯ ط§ظ„ط®ط§ظ… ط¢ظ„ظٹط§ظ‹ ط¨ظ†ط§ط،ظ‹ ط¹ظ„ظ‰ ط·ظ„ط¨ط§طھ ط§ظ„ط¥ظ†طھط§ط¬ ظˆطھظˆظ„ظٹط¯ ط·ظ„ط¨ط§طھ ط§ظ„ط´ط±ط§ط، طھظ„ظ‚ط§ط¦ظٹط§ظ‹.' },
  { icon: <Package size={20}/>, title: 'ط¥ط¯ط§ط±ط© ط§ظ„ظ‡ط§ظ„ظƒ ظˆط§ظ„ظ…ط®ظ„ظپط§طھ', desc: 'طھطھط¨ط¹ ط§ظ„ظƒظ…ظٹط§طھ ط§ظ„ظ…ظپظ‚ظˆط¯ط© ظپظٹ ظƒظ„ ظ…ط±ط­ظ„ط© ط¥ظ†طھط§ط¬. طھط­ظ„ظٹظ„ ظ…ط¹ط¯ظ„ ط§ظ„ظ‡ط§ظ„ظƒ ظˆتقارير ط§ظ„طھط­ط³ظٹظ† ط§ظ„ظ…ط³طھظ…ط±.' },
  { icon: <GitMerge size={20}/>, title: 'ط§ظ„تحويلط§طھ ط¨ظٹظ† ط§ظ„مستودعط§طھ', desc: 'ط­ط±ظƒط© ط§ظ„ظ…ظˆط§ط¯ ط§ظ„ط®ط§ظ… ظ…ظ† ط§ظ„مستودع ظ„ظ„ط¥ظ†طھط§ط¬ ظˆط­ط±ظƒط© المنتج ط§ظ„طھط§ظ… ظ„ظ„مستودع ط§ظ„ط±ط¦ظٹط³ظٹ ط¢ظ„ظٹط§ظ‹ ظˆظ…ظڈط­ط§ط³ط¨ظٹط§ظ‹.' },
  { icon: <Factory size={20}/>, title: 'ط£ظˆط§ظ…ط± ط§ظ„طھط´ط؛ظٹظ„', desc: 'ط¥طµط¯ط§ط± ط£ظ…ط± طھط´ط؛ظٹظ„ رقمظٹ ظٹط­ط¬ط² ط§ظ„ظ…ظˆط§ط¯ ط§ظ„ط®ط§ظ… ظˆظٹط·ظ„ظ‚ ط¹ظ…ظ„ظٹط© ط§ظ„ط¥ظ†طھط§ط¬ ظ…ط¹ طھطھط¨ط¹ ظƒط§ظ…ظ„ ظ„ط­ط§ظ„ط© ط§ظ„طھظ†ظپظٹط°.' },
  { icon: <BarChart3 size={20}/>, title: 'تقارير ط§ظ„ظƒظپط§ط،ط© ط§ظ„ط¥ظ†طھط§ط¬ظٹط©', desc: 'ظƒظپط§ط،ط© ط®ط· ط§ظ„ط¥ظ†طھط§ط¬طŒ ظ…ط¹ط¯ظ„ ط§ظ„ط¹ظٹظˆط¨طŒ طھظƒظ„ظپط© الوحدةطŒ ظˆطھط­ظ„ظٹظ„ ط§ظ„ظپط¬ظˆط© ط¨ظٹظ† ط§ظ„ظ…ط®ط·ط· ظˆط§ظ„ظپط¹ظ„ظٹ.' },
];
  ...
  return (
    <div className="min-h-screen" dir="rtl" style={{ fontFamily: "'Lateef', sans-serif", background: '#F8FAFC' }}>
      ...
      <div className="bg-gradient-to-br from-blue-900 via-indigo-900 to-slate-900 text-white py-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-black mb-4 leading-tight">
            ...
            <br/>
            <span className="text-blue-300 text-3xl md:text-4xl">رقمظٹط© ظپط§ط¦ظ‚ط© ط§ظ„ظƒظپط§ط،ط©</span>
          </h1>
          ...
          <p className="text-slate-300 text-base mb-10 max-w-2xl mx-auto">
            ظ…ظ† ط§ظ„ظ…ط§ط¯ط© ط§ظ„ط®ط§ظ… ط¥ظ„ظ‰ المنتج ط§ظ„ظ†ظ‡ط§ط¦ظٹ â€” طھطھط¨ط¹ ظƒظ„ ظ…ط±ط­ظ„ط© ظپظٹ ط®ط· ط§ظ„ط¥ظ†طھط§ط¬ ظˆط§ط­ط³ط¨ طھظƒط§ظ„ظٹظپظƒ ط¨ط¯ظ‚ط© ظ…طھظ†ط§ظ‡ظٹط©.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a href="https://wa.me/966531206628" target="_blank" className="px-7 py-3.5 bg-blue-500 hover:bg-blue-400 text-white font-bold rounded-xl shadow-lg transition-all flex items-center gap-2">
              <Phone size={18}/> ط·ظ„ط¨ عرض طھظˆط¶ظٹط­ظٹ
            </a>
            <Link href="/#modules" className="px-7 py-3.5 bg-white/10 hover:bg-white/20 border border-white/20 text-white font-bold rounded-xl transition-all">
              ط§ط³طھعرض ط¬ظ…ظٹط¹ ط§ظ„ظ…ظٹط²ط§طھ
            </Link>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-blue-900 to-indigo-900 text-white py-16 px-4 text-center">
        ...
        <p className="text-blue-200 mb-8">تواصل ظ…ط¹ظ†ط§ ظ„ظ„ط­طµظˆظ„ ط¹ظ„ظ‰ عرض طھظˆط¶ظٹط­ظٹ مجاني</p>
        <div className="flex flex-wrap justify-center gap-4">
          <a href="https://wa.me/966531206628" target="_blank" className="px-8 py-4 bg-white text-blue-800 font-black rounded-xl hover:bg-blue-50 flex items-center gap-2 transition-all">
            <Phone size={18}/> تواصل ط¹ط¨ط± ظˆط§طھط³ط§ط¨
          </a>
