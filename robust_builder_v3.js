...
if (enMatch) {
    ...
    enDictSidebar = require('./temp_en');
}

// Load HI, BN, UR mappings
...
// For Hindi, if there was stuff in the original, keep it. Add injected.
...
console.log('Successfully generated pure static translations.ts WITH MERGED ENGLISH DICTIONARY!');

// Cleanup
fs.unlinkSync('temp_base.js');
try{ fs.unlinkSync('temp_en.js'); }catch(e){}
