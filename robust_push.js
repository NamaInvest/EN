...
const pageTsx = fs.readFileSync('d:/namasoft9-3-main/src/app/(dashboard)/shifts/page.tsx', 'utf8');
const routeTs = fs.readFileSync('d:/namasoft9-3-main/src/app/api/shifts/route.ts', 'utf8');
