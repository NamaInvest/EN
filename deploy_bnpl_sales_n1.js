...
const fileTasks = [
    { local: 'd:/namasoft9-3-main/src/app/(dashboard)/sales/page.tsx', remote: '/src/app/(dashboard)/sales/page.tsx' },
    { local: 'd:/namasoft9-3-main/src/app/api/bnpl/status/route.ts', remote: '/src/app/api/bnpl/status/route.ts' }
];
...
async function rebuildServer(i) {
    return new Promise((resolve) => {
        ...
        conn.on('ready', async () => {
            console.log(`\n============================`);
            console.log(`[N${i}] Commencing BNPL Sales Deployment...`);
            ...
            conn.sftp(async (err, sftp) => {
                ...
                try {
                    ...
                    console.log(`[N${i}] Done! BNPL globally enabled on standard sales.`);
                } catch (e) {
...
async function run() {
    console.log('Starting Phase 8.2 BNPL Upgrade on N1...');
