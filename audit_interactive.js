...
const BASE = 'd:/namasoft9-3-main/src/app';
const results = [];
...
scanDir(BASE);
scanComponents('d:/namasoft9-3-main/src/components');
...
// Output as JSON
fs.writeFileSync('d:/namasoft9-3-main/audit_results.json', JSON.stringify(byModule, null, 2), 'utf8');
