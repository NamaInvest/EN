...
conn.on('ready', () => {
    conn.sftp((err, sftp) => {
        ...
        const uploads = [
            ...
            { local: 'd:/namasoft9-3-main/src/app/api/auth/sync/route.ts', remote: `${N7}/src/app/api/auth/sync/route.ts` },
            { local: 'd:/namasoft9-3-main/src/app/api/auth/sync/route.ts', remote: `${N11}/src/app/api/auth/sync/route.ts` },
        ];
