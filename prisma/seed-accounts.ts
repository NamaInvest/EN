...
const defaultAccounts = [
    ...
    { code: '1310', name: 'بضاعة بالطريق', nameEn: 'Goods in Transit', type: 'asset', parentId: 0, level: 3 },
    { code: '1330', name: 'مخزون تحت التشغيل', nameEn: 'Work-in-Process (WIP)', type: 'asset', parentId: 0, level: 3 },
    { code: '1340', name: 'مخزون البضاعة التامة', nameEn: 'Finished Goods', type: 'asset', parentId: 0, level: 3 },
    ...
    { code: '5120', name: 'مصروف عجز وتسوية مخزون', nameEn: 'Inventory Shrinkage', type: 'expense', parentId: 0, level: 1 },
    { code: '5130', name: 'انحرافات تكاليف الإنتاج', nameEn: 'Manufacturing Variance', type: 'expense', parentId: 0, level: 1 },
