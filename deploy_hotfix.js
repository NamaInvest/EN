...
const FILES = [
    ...
    "src/app/(dashboard)/settings/dashboard-builder/page.tsx",
    "src/app/(dashboard)/settings/workflow-builder/page.tsx",
    ...
    "src/app/(dashboard)/hr/self-service/page.tsx",
    "src/app/(dashboard)/contracts/page.tsx",
    "src/app/(dashboard)/calendar/page.tsx",
    "src/app/(dashboard)/manufacturing/quality/page.tsx",
];
...
async function run() {
    ...
    conn.on('ready', async () => {
        console.log('Connected — HOTFIX DEPLOY');
