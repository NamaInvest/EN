...
| نقاط البيع | /pos | زر السلة العائم | Button | onClick | فتح عرض السلة الجانبي المنبثق على الجوال | آمن | SCN-POS-002 | مكتمل | لا يوجد |
| نقاط البيع | /pos | إعادة فحص اتصال الطابعة | Button | Client connection check | إعادة تشغيل فحص اتصال QZ Tray محلياً | آمن | SCN-POS-003 | مكتمل | لا يوجد |
...
| التقارير | /reports | الانتقال بين الصفحات (السابق/التالي) | Button | onClick | تصفح سجلات التقارير المصفحة ديناميكياً | آمن (عرض فقط) | SCN-REPORTS-002 | مكتمل | لا يوجد |
| التقارير | /reports | تغيير حجم الصفحة (limit) | Select | onChange | تعديل عدد السجلات المعروضة في الصفحة | آمن (عرض فقط) | SCN-REPORTS-002 | مكتمل | لا يوجد |
