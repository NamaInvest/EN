...
conn.on('ready', () => {
    conn.sftp((err, sftp) => {
        ...
        const uploads = [
            { local: 'd:/namasoft9-3-main/src/lib/prisma.ts',      remote: `${MASTER}/src/lib/prisma.ts` },
            { local: 'd:/namasoft9-3-main/src/middleware.ts',       remote: `${MASTER}/src/middleware.ts` },
            { local: 'd:/namasoft9-3-main/ecosystem.config.js',     remote: `${MASTER}/ecosystem.config.js` },
        ];
