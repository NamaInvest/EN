...
conn.on('ready', () => {
    conn.sftp((err, sftp) => {
        if (err) throw err;
        console.log('Uploading sales/page.tsx...');
        sftp.fastPut('src/app/(dashboard)/sales/page.tsx', '/www/wwwroot/n1.namainvist.com/src/app/(dashboard)/sales/page.tsx', (err) => {
            ...
            const buildCmd = `
                ...
                npm run build > build_quick.log 2>&1
