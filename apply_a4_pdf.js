...
// 1. Inject the necessary State Variables
...
// 2. Inject the Token into Cashier fetch!
// Let's find the current fetch inside init()
...
// 4. Overwrite handleExportPDF to use A4 layout with parameters
...
const endIdx = searchLines.findIndex((l, i) => i > startIdx && l.includes('}, [invoiceData, invoiceId, printerType, isQuote]);'));
    ...
    const newHandleExportPDF = `    const handleExportPDF = useCallback(() => {
        ...
        script.onload = () => {
            ...
            const paymentLabel = (method) => {
                const labels = { cash: 'نقدي', card: 'بطاقة', transfer: 'تحويل بنكي', credit: 'آجل' };
                ...
                <head>
                    <style>
                        ...
                        * { margin: 0; padding: 0; box-sizing: border-box; }
                        ...
                        .bilingual-header > div {
                            width: 48%;
                        }
                        .bilingual-header .ar-side {
                            text-align: right;
                        }
                        .bilingual-header .en-side {
                            text-align: left;
                            direction: ltr;
                        }
                        .bilingual-header p {
                    ...
                    <div class="a4-container">
                        ...
                        <div class="bilingual-header">
                            <div class="ar-side">
                                ...
                                <p><strong>رقم السجل التجاري:</strong> \${crNumber}</p>
                                <br/>
                        ...
                        <!-- QRCode for simplified validation -->
