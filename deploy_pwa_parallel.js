    ...
    conn.sftp(async (err, sftp) => {
        ...
        try {
            ...
            for(let i=1; i<=10; i++) {
                ...
                proms.push(new Promise((r, j) => sftp.fastPut('d:/namasoft9-3-main/public/sw.js', targetPath + 'sw.js', e => e?j(e):r())));
                proms.push(new Promise((r, j) => sftp.fastPut('d:/namasoft9-3-main/public/manifest.webmanifest', targetPath + 'manifest.webmanifest', e => e?j(e):r())));
