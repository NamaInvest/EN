    ...
    conn.exec(`mkdir -p ${basePath}/src/app/restaurant-pos`, (err, stream) => {
        ...
        stream.on('close', () => {
            ...
            conn.sftp((err, sftp) => {
                ...
                try {
                    const files = [
                        { local: 'd:/namasoft9-3-main/src/app/restaurant-pos/page.tsx', remote: `${basePath}/src/app/restaurant-pos/page.tsx` },
                        { local: 'd:/namasoft9-3-main/src/components/Sidebar.tsx', remote: `${basePath}/src/components/Sidebar.tsx` }
                    ];
