...
conn.on('ready', () => { 
    conn.sftp(async (err, sftp) => {
        ...
        try {
            ...
            let proms = [];
            for(let i=1; i<=10; i++) {
                proms.push(new Promise((r, j) => sftp.fastPut('d:/namasoft9-3-main/src/components/LanguageSwitcher.tsx', '/www/wwwroot/n'+i+'.namainvist.com/src/components/LanguageSwitcher.tsx', e => e?j(e):r())));
                proms.push(new Promise((r, j) => sftp.fastPut('d:/namasoft9-3-main/src/app/globals.css', '/www/wwwroot/n'+i+'.namainvist.com/src/app/globals.css', e => e?j(e):r())));
            }
