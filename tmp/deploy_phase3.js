...
async function run() {
  console.log('--- Phase 3: Tax Group Validation Deployment & Verification ---');
  
  // 1. Calculate Local SHA256
  console.log('\n[1/5] Calculating Local SHA256 Cheksums...');
  const localHashes = {};
  ...
  conn.on('ready', async () => {
    try {
      ...
      console.log('\n🎉 --- PRODUCTION_TAX_GROUP_VALIDATION_DEPLOYED_AND_VERIFIED ---');
