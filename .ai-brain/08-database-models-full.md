...
> **إجمالي الأسطر في schema.prisma:** 12326

> **تم التوليد تلقائياً من الكود الفعلي بتاريخ:** 2026-06-02T07:57:11.202Z

## إحصائيات
- **عدد الجداول (Models):** 626
- **عدد التعدادات (Enums):** 3
...
498. `ICNettingCycle` (8 حقل)
499. `ICNettingLine` (20 حقل)
...
515. `WmsWave` (8 حقل)
516. `WmsTask` (11 حقل)
517. `DemandForecast` (7 حقل)
518. `InventoryBin` (7 حقل)
519. `EquityStatementLine` (7 حقل)
520. `CashFlowLine` (7 حقل)
521. `FsNote` (7 حقل)
522. `OperatingSegment` (6 حقل)
523. `SegmentResult` (7 حقل)
524. `CopaAllocation` (5 حقل)
525. `AssetRetirementObligation` (8 حقل)
526. `AROAccretion` (5 حقل)
527. `DunningExecution` (8 حقل)
528. `BadDebtProvision` (7 حقل)
529. `VendorOnboarding` (12 حقل)
530. `ReverseAuction` (10 حقل)
531. `AuctionBid` (6 حقل)
532. `SpendCategory` (6 حقل)
533. `SpendClassification` (7 حقل)
534. `BlanketPO` (10 حقل)
535. `BlanketPORelease` (7 حقل)
536. `DropShipLink` (5 حقل)
537. `SlottingRecommendation` (8 حقل)
538. `CrossDockAssignment` (7 حقل)
539. `ShopfloorStation` (8 حقل)
540. `ShopfloorEvent` (6 حقل)
541. `ScheduleRun` (5 حقل)
542. `SpcChart` (10 حقل)
543. `SpcMeasurement` (8 حقل)
544. `OEERecord` (11 حقل)
545. `SopCycle` (6 حقل)
546. `CalibratableEquipment` (7 حقل)
547. `CalibrationRecord` (7 حقل)
548. `SuccessionPlan` (5 حقل)
549. `SuccessionCandidate` (6 حقل)
550. `NineBoxRating` (7 حقل)
551. `Competency` (6 حقل)
552. `EmployeeCompetency` (6 حقل)
553. `CareerPath` (4 حقل)
554. `CompReviewCycle` (6 حقل)
555. `EmployeeCompProposal` (7 حقل)
556. `Objective` (7 حقل)
557. `KeyResult` (6 حقل)
558. `Candidate` (7 حقل)
559. `JobApplication` (6 حقل)
560. `AttendanceDevice` (6 حقل)
561. `AttendancePunch` (9 حقل)
562. `SafetyIncident` (10 حقل)
563. `AudienceSegment` (6 حقل)
564. `CampaignJourney` (3 حقل)
565. `CustomerHealth` (7 حقل)
566. `SalesTerritory` (6 حقل)
567. `SalesQuota` (6 حقل)
568. `ForecastCommit` (8 حقل)
569. `SurveyTemplate` (5 حقل)
570. `SurveyResponse` (8 حقل)
571. `Conversation` (8 حقل)
572. `ConversationMessage` (6 حقل)
573. `CustomPage` (7 حقل)
574. `CustomForm` (6 حقل)
575. `SsoProvider` (9 حقل)
576. `EncryptedField` (8 حقل)
577. `FinancialPeriod` (11 حقل)
578. `FinancialPeriodModuleLock` (10 حقل)
579. `AccrualEntry` (18 حقل)
580. `CollectionActivity` (11 حقل)
581. `PrepaymentSchedule` (9 حقل)
582. `DemandForecastV2` (14 حقل)
583. `EmissionLog` (14 حقل)
584. `EnergyConsumption` (8 حقل)
585. `WaterConsumption` (6 حقل)
586. `WasteLog` (7 حقل)
587. `SustainabilityGoal` (9 حقل)
588. `DiversitySnapshot` (10 حقل)
589. `EVMSnapshot` (20 حقل)
590. `ActivityPool` (8 حقل)
591. `ProductActivityConsumption` (6 حقل)
592. `PoAcknowledgment` (8 حقل)
593. `AdvanceShipNotice` (12 حقل)
594. `VendorOnboardingStep` (9 حقل)
595. `WaiterCall` (7 حقل)
596. `IceAdmin` (19 حقل)
597. `IceAdminRole` (6 حقل)
598. `IceSubscriptionPlan` (18 حقل)
599. `IceTenantSubscription` (14 حقل)
600. `IceSubscriptionInvoice` (15 حقل)
601. `IceSystemModule` (12 حقل)
602. `IcePlanModule` (5 حقل)
603. `IceTenantModule` (5 حقل)
604. `IceDesktopLicense` (13 حقل)
605. `IceAuditLog` (11 حقل)
606. `IceLoginLog` (8 حقل)
607. `IceSupportTicket` (11 حقل)
608. `IceSupportReply` (9 حقل)
609. `IceSystemSetting` (5 حقل)
610. `IdempotencyRecord` (12 حقل)
611. `OutboxEvent` (12 حقل)
612. `Sprint` (10 حقل)
613. `Story` (18 حقل)
614. `SprintStory` (6 حقل)
615. `TestRun` (6 حقل)
616. `MigrationRun` (10 حقل)
617. `TrainingVideo` (6 حقل)
618. `TrainingProgress` (7 حقل)
619. `UserAgreement` (7 حقل)
620. `ChainState` (11 حقل)
621. `FeatureFlag` (9 حقل)
622. `OpenItemMatching` (23 حقل)
623. `ConsolidationEliminationRequest` (36 حقل)
624. `ConsolidationEliminationApproval` (9 حقل)
625. `ConsolidationEliminationSnapshot` (5 حقل)
626. `ConsolidationEliminationPosting` (9 حقل)
...
| `deletedAt` | `DateTime?` | // P1.2 soft-delete — لا تستخدم hard DELETE |
...
| `openItemMatchings` | `OpenItemMatching[]` | @relation("SalesInvoiceMatchings") |
| `deletedAt` | `DateTime?` | @map("deleted_at") |
| `deletedBy` | `String?` | @map("deleted_by") |
...
| `openItemMatchings` | `OpenItemMatching[]` | @relation("SalesReturnMatchings") |
| `deletedAt` | `DateTime?` | @map("deleted_at") |
| `deletedBy` | `String?` | @map("deleted_by") |
...
| `ThreeWayMatch` | `ThreeWayMatch?` |  |
| `whtTransactions` | `WHTTransaction[]` |  |
| `openItemMatchings` | `OpenItemMatching[]` | @relation("PurchaseInvoiceMatchings") |
| `deletedAt` | `DateTime?` | @map("deleted_at") |
| `deletedBy` | `String?` | @map("deleted_by") |
...
| `openItemMatchings` | `OpenItemMatching[]` | @relation("PurchaseReturnMatchings") |
| `deletedAt` | `DateTime?` | @map("deleted_at") |
| `deletedBy` | `String?` | @map("deleted_by") |
...
| `branch` | `Branch?` | @relation(fields: [branchId], references: [id]) |
| `branchId` | `Int?` | @map("branch_id") |
| `openItemMatchings` | `OpenItemMatching[]` | @relation("TreasuryMatchings") |
| `deletedAt` | `DateTime?` | // P1.2 soft-delete — لا تستخدم hard DELETE |
...
| `eliminationRequests` | `ConsolidationEliminationRequest[]` |  |
...
| `firstFiveYearsAmount` | `Decimal` | @map("first_five_years_amount") @db.Decimal(15, 2) // EOS first 5 years |
| `remainingYearsAmount` | `Decimal` | @map("remaining_years_amount") @db.Decimal(15, 2) // EOS remaining years |
...
| `fromCompanyId` | `Int?` | @map("from_company_id") |
| `toCompanyId` | `Int?` | @map("to_company_id") |
| `debtorTenantId` | `String?` | @map("debtor_tenant_id") |
| `creditorTenantId` | `String?` | @map("creditor_tenant_id") |
| `invoiceId` | `Int?` | @map("invoice_id") |
| `fromJournalId` | `Int?` | @map("from_journal_id") |
| `toJournalId` | `Int?` | @map("to_journal_id") |
| `currency` | `String` |  |
...
| `reference` | `String?` |  |
| `status` | `String?` |  |
| `nettedAt` | `DateTime?` | @map("netted_at") |
...
| `createdAt` | `DateTime` | @default(now()) @map("created_at") |
| `wave` | `WmsWave` | @relation(fields: [waveId], references: [id], onDelete: Cascade) |
...
## Model: `FinancialPeriodModuleLock`
| الحقل | النوع | الوصف |
|---|---|---|
| `id` | `Int` | @id @default(autoincrement()) |
| `tenantId` | `String` | @map("tenant_id") |
| `period` | `String` | // YYYY-MM |
| `module` | `String` | // e.g., 'sales', 'purchases', 'inventory', 'treasury', 'gl', 'fixed_assets', 'payroll', 'tax' |
| `status` | `FinancialPeriodStatus` | @default(OPEN) |
| `lockedBy` | `String?` | @map("locked_by") |
| `lockedAt` | `DateTime?` | @map("locked_at") |
| `reason` | `String?` |  |
...
## Model: `OpenItemMatching`
| الحقل | النوع | الوصف |
|---|---|---|
| `id` | `Int` | @id @default(autoincrement()) |
| `tenantId` | `String` | @default("default") @map("tenant_id") |
| `salesInvoiceId` | `Int?` | @map("sales_invoice_id") |
| `salesInvoice` | `SalesInvoice?` | @relation("SalesInvoiceMatchings", fields: [salesInvoiceId], references: [id], onDelete: Restrict) |
| `purchaseReturnId` | `Int?` | @map("purchase_return_id") |
| `purchaseReturn` | `PurchaseReturn?` | @relation("PurchaseReturnMatchings", fields: [purchaseReturnId], references: [id], onDelete: Restrict) |
| `purchaseInvoiceId` | `Int?` | @map("purchase_invoice_id") |
| `purchaseInvoice` | `PurchaseInvoice?` | @relation("PurchaseInvoiceMatchings", fields: [purchaseInvoiceId], references: [id], onDelete: Restrict) |
| `salesReturnId` | `Int?` | @map("sales_return_id") |
| `salesReturn` | `SalesReturn?` | @relation("SalesReturnMatchings", fields: [salesReturnId], references: [id], onDelete: Restrict) |
| `treasuryId` | `Int?` | @map("treasury_id") |
| `treasury` | `Treasury?` | @relation("TreasuryMatchings", fields: [treasuryId], references: [id], onDelete: Restrict) |
| `amount` | `Decimal` | @map("amount") @db.Decimal(20, 4) |
| `allocatedAt` | `DateTime` | @default(now()) @map("allocated_at") |
| `allocatedBy` | `String` | @map("allocated_by") // e.g. "SYSTEM_FIFO", "MANUAL_USER", "AUTO_POS" |
| `sourceType` | `String` | @default("MANUAL") @map("source_type") // "MANUAL", "FIFO", "AUTO_CASH_SALE" |
| `status` | `String` | @default("ACTIVE") @map("status") // "ACTIVE", "REVERSED" |
...
## Model: `ConsolidationEliminationRequest`
| الحقل | النوع | الوصف |
|---|---|---|
| `id` | `String` | @id @default(cuid()) |
| `tenantId` | `String` | @map("tenant_id") |
...
| `periodKey` | `String` | @map("period_key") // e.g. "2026-05" |
| `status` | `String` | @default("DRAFT") // DRAFT | SUBMITTED | CFO_APPROVED | MASTER_APPROVED | POSTING_READY | POSTING_IN_PROGRESS | POSTED | REVERSED | REJECTED | CANCELLED | FAILED |
| `previewHash` | `String` | @map("preview_hash") |
| `snapshotJson` | `Json` | @map("snapshot_json") // Stores proposed lines snapshot |
| `totalDebit` | `Decimal` | @db.Decimal(20, 4) @map("total_debit") |
| `totalCredit` | `Decimal` | @db.Decimal(20, 4) @map("total_credit") |
| `isBalanced` | `Boolean` | @default(true) @map("is_balanced") |
| `postingReference` | `String?` | @map("posting_reference") |
| `reversalReference` | `String?` | @map("reversal_reference") |
| `autoReverseDate` | `DateTime?` | @map("auto_reverse_date") |
| `createdBy` | `String` | @map("created_by") |
| `submittedBy` | `String?` | @map("submitted_by") |
| `cfoApprovedBy` | `String?` | @map("cfo_approved_by") |
| `masterApprovedBy` | `String?` | @map("master_approved_by") |
| `postedBy` | `String?` | @map("posted_by") |
| `reversedBy` | `String?` | @map("reversed_by") |
| `rejectedBy` | `String?` | @map("rejected_by") |
| `rejectionReason` | `String?` | @map("rejection_reason") |
| `journalEntryId` | `Int?` | @map("journal_entry_id") |
| `reversalJournalEntryId` | `Int?` | @map("reversal_journal_entry_id") |
| `createdAt` | `DateTime` | @default(now()) @map("created_at") |
| `submittedAt` | `DateTime?` | @map("submitted_at") |
| `cfoApprovedAt` | `DateTime?` | @map("cfo_approved_at") |
...
| `updatedAt` | `DateTime` | @updatedAt @map("updated_at") |
| `group` | `ConsolidationGroup` | @relation(fields: [groupId], references: [id]) |
| `approvals` | `ConsolidationEliminationApproval[]` |  |
| `postings` | `ConsolidationEliminationPosting[]` |  |

## Model: `ConsolidationEliminationApproval`
| الحقل | النوع | الوصف |
|---|---|---|
| `id` | `String` | @id @default(cuid()) |
| `tenantId` | `String` | @map("tenant_id") |
...
| `actorRole` | `String` | @map("actor_role") // CFO | MASTER_ADMIN | SUPER_ADMIN |
| `decision` | `String` | @map("decision") // APPROVED | REJECTED |
| `reason` | `String?` | @db.Text |
| `createdAt` | `DateTime` | @default(now()) @map("created_at") |
| `request` | `ConsolidationEliminationRequest` | @relation(fields: [requestId], references: [id], onDelete: Cascade) |

## Model: `ConsolidationEliminationSnapshot`
| الحقل | النوع | الوصف |
|---|---|---|
| `id` | `String` | @id @default(cuid()) |
| `tenantId` | `String` | @map("tenant_id") |
| `requestId` | `String` | @unique @map("request_id") |
| `payload` | `Json` | @db.JsonB // Stores the full dryRunProposedEntries array |
| `createdAt` | `DateTime` | @default(now()) @map("created_at") |

## Model: `ConsolidationEliminationPosting`
| الحقل | النوع | الوصف |
|---|---|---|
| `id` | `String` | @id @default(cuid()) |
| `tenantId` | `String` | @map("tenant_id") |
...
القيم: `OPEN`, `SOFT_LOCKED`, `HARD_LOCKED`
