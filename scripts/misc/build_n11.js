...
conn.on('ready', () => {
    conn.sftp((err, sftp) => {
        ...
        sftp.fastPut('c:/Users/1/Desktop/alfa/src/app/page.tsx', `${N11}/src/app/page.tsx`, {}, (e) => {
            if (e) { console.error('❌ page.tsx:', e.message); }
            sftp.fastPut('c:/Users/1/Desktop/alfa/src/components/SessionGuard.tsx', `${N11}/src/components/SessionGuard.tsx`, {}, (e2) => {
