...
(async () => {
    console.log("=== settings/page.tsx lines around ZATCA API ===");
    console.log(await ssh(`cat /www/wwwroot/n11.namainvist.com/src/app/\\(dashboard\\)/settings/page.tsx | grep -B 20 -A 20 "Check ZATCA connection status"`));
})();
