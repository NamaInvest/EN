...
const fs = require('fs');
fs.writeFileSync('c:\\Users\\1\\Desktop\\alfa\\patch_warehouse_labels.js', scriptCode, 'utf8');

const conn = new Client();
conn.on('ready', () => {
    conn.sftp((err, sftp) => {
        if (err) throw err;
        sftp.fastPut('c:\\Users\\1\\Desktop\\alfa\\patch_warehouse_labels.js', '/tmp/patch_warehouse_labels.js', (err) => {
            if (err) throw err;
