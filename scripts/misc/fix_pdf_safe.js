...
let endIdx = lines.findIndex((l, i) => i > startIdx && l.includes('    }, [printerType, invoiceData, invoiceId, isQuote, companyName, vatNumber, t]);'));
...
if (startIdx !== -1 && endIdx !== -1) {
    ...
    console.log("Replaced handleExportPDF safely");
} else {
