...
const LABELS: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    'i.delivery_notes': 'مذكرات التسليم', 'i.sales_returns': 'مرتجعات المبيعات',
    ...
    'i.purchases': 'فواتير المشتريات', 'i.purchase_returns': 'مرتجعات المشتريات', 'i.lc': 'الاعتمادات المستندية',
  ...
  en: {
    ...
    'i.delivery_notes': 'Delivery Notes', 'i.sales_returns': 'Sales Returns',
    ...
    'i.purchases': 'Purchase Invoices', 'i.purchase_returns': 'Purchase Returns', 'i.lc': 'Letters of Credit (LC)',
  ...
  hi: {
    ...
    'i.grn': 'माल रसीद', 'i.purchases': 'खरीद इनवॉइस', 'i.purchase_returns': 'खरीद वापसी',
  ...
  bn: {
    ...
    'i.grn': 'পণ্য রসিদ', 'i.purchases': 'ক্রয় ইনভয়েস', 'i.purchase_returns': 'ক্রয় ফেরত',
  ...
  ur: {
    ...
    'i.grn': 'مال رسید', 'i.purchases': 'خریداری انوائس', 'i.purchase_returns': 'خریداری واپسی',
...
fs.writeFileSync('src/components/Sidebar.tsx', SIDEBAR_CODE, 'utf8');
console.log('Sidebar.tsx written from scratch!', fs.statSync('src/components/Sidebar.tsx').size, 'bytes');
