...
conn.on('ready', () => {
    ...
    // We base64 encode the script to avoid ANY escaping issues in bash
    const scriptBody = `
...
`;
    ...
    const script = `cd /www/wwwroot/namainvist.com && echo "${b64}" | base64 -d > /tmp/zatca_test.js && node /tmp/zatca_test.js`;
