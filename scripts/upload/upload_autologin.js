...
conn.on('ready', () => {
    conn.sftp((err, sftp) => {
        ...
        conn.exec(`mkdir -p ${N11}/src/app/auto-login && mkdir -p ${N11}/src/app/api/auth/auto-login`, (err1) => {
            ...
            sftp.fastPut('c:/Users/1/Desktop/alfa/src/app/auto-login/page.tsx', `${N11}/src/app/auto-login/page.tsx`, done);
            sftp.fastPut('c:/Users/1/Desktop/alfa/src/app/api/auth/auto-login/route.ts', `${N11}/src/app/api/auth/auto-login/route.ts`, done);
            sftp.fastPut('c:/Users/1/Desktop/alfa/src/middleware.ts', `${N11}/src/middleware.ts`, done);
        });
    });
