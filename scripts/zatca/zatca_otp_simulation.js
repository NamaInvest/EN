...
async function run() {
    ...
    const otp = '123345'; // Latest Sandbox/Simulation OTP from User
...
csr.industry.business.category=Restaurant`;
    ...
    const tmp = '/tmp/zatca_otp_test3_' + Date.now();
    ...
    console.log('--- Testing ULTIMATE PRE- SIMULATION WITH LATEST OTP ---');
    ...
    // Test if Developer Sandbox responds differently:
