...
const filesToDeploy = [
    {
        local: 'c:/Users/1/Desktop/alfa/src/app/api/auth/login/route.ts',
        remotes: [`${N11}/src/app/api/auth/login/route.ts`]
    },
    {
        local: 'c:/Users/1/Desktop/alfa/src/app/api/tenant/provision/route.ts',
        remotes: [`${MAIN}/src/app/api/tenant/provision/route.ts`, `${N11}/src/app/api/tenant/provision/route.ts`]
    },
    {
        local: 'c:/Users/1/Desktop/alfa/src/app/(dashboard)/company-info/page.tsx',
        remotes: [`${N11}/src/app/(dashboard)/company-info/page.tsx`]
    },
    {
        local: 'c:/Users/1/Desktop/alfa/src/app/company-info/page.tsx',
