...
conn.on('ready', () => {
    conn.sftp((err, sftp) => {
        ...
        let done = 0;
        const files = [
            ['c:/Users/1/Desktop/alfa/src/middleware.ts', '/www/wwwroot/namainvist.com/src/middleware.ts'],
            ['c:/Users/1/Desktop/alfa/src/middleware.ts', '/www/wwwroot/n11.namainvist.com/src/middleware.ts'],
        ];
