...
const f5 = fs.readFileSync('src/app/(dashboard)/sales/page.tsx');
const f6 = fs.readFileSync('src/app/(dashboard)/sales/options/page.tsx');
...
fs.writeFileSync('/www/wwwroot/n11.namainvist.com/src/app/(dashboard)/sales/page.tsx', Buffer.from('${f5.toString('base64')}', 'base64').toString('utf8'));
fs.writeFileSync('/www/wwwroot/n11.namainvist.com/src/app/(dashboard)/sales/options/page.tsx', Buffer.from('${f6.toString('base64')}', 'base64').toString('utf8'));
console.log('Inclusive Tax Extended Update Files Copied');
`;
