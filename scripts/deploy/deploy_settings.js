...
conn.on('ready', () => {
    conn.sftp((err, sftp) => {
        ...
        const uploads = [
            { local: 'c:/Users/1/Desktop/alfa/src/app/(dashboard)/settings/page.tsx', remote: `${N7}/src/app/(dashboard)/settings/page.tsx` },
            { local: 'c:/Users/1/Desktop/alfa/src/app/(dashboard)/settings/page.tsx', remote: `${N11}/src/app/(dashboard)/settings/page.tsx` },
        ];
