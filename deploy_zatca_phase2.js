...
conn.on('ready', () => { 
    conn.sftp(async (err, sftp) => {
        ...
        try {
            ...
            await new Promise((r, j) => sftp.fastPut('d:/namasoft9-3-main/zatca-sdk.zip', '/root/zatca-sdk.zip', e => e?j(e):r()));
            ...
            for(let i=1; i<=10; i++) {
                ...
                for(const file of filesToSync) {
                    proms.push(new Promise((r, j) => sftp.fastPut(`d:/namasoft9-3-main/${file}`, `${targetPath}${file}`, e => e?j(e):r())));
                }
            }
