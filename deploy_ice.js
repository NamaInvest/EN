...
c.on('ready', () => {
    c.sftp((e, sftp) => {
        const content = fs.readFileSync('src/app/login/page.tsx');
        const targets = [
            '/www/wwwroot/n11.namainvist.com/src/app/login/page.tsx',
            '/www/wwwroot/namainvist.com/src/app/login/page.tsx',
        ];
        let done = 0;
