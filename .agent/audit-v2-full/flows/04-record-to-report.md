...
This horizontal flow tracks the lifecycle of 04 Record to Report across multiple sub-systems.
**Modules Involved:** All Sub-ledgers → General Ledger → Reporting

## 2. Event Bus Handoffs & Triggers
The system relies on asynchronous event-driven architecture to decouple modules.
### Event: `SUB_LEDGER_CLOSED`
- **Publisher:** Module A
- **Subscriber:** Module B
